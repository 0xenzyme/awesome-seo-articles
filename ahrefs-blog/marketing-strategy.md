...
canonical: "https://ahrefs.com/blog/marketing-strategy/"
author: "Michal Pecánek"
published: "2021-05-26T16:16:52+00:00"
updated: "2023-10-04T14:04:56+00:00"
categories:
  - "General Marketing"
freshness_reasons:
  - "date_2023_aging"
fetched_at: "2026-06-12T11:48:36+00:00"
status_code: 200
html_hash: "153fdbfcd82c109ad9fd5a5f9a575610db8077979c199699be1f7b88aebb6da0"
clean_word_count: 3460
clean_char_count: 21469
---
...
Having a marketing strategy is more crucial than ever. We’re swamped with new technologies, growth hacks, and “must-try” [marketing tactics](https://ahrefs.com/blog/marketing-tactics/). A solid marketing strategy will help you to focus on things that really matter and execute them properly.
...
1. [Have your market research data ready](#market-research-data)
2. [Decide which segments you’ll target](#target-segments)
3. [Appeal to your target market with proper positioning](#positioning)
4. [Choose a few brand codes to become distinctive](#brand-codes)
5. [Set strategic objectives for the year ahead](#set-strategic-objectives)

Let’s dive into it.

## 1. Have your market research data ready

It’s crucial to build your marketing strategy on data, not assumptions. You’re probably not developing and launching a product into the marketplace without [market research](https://ahrefs.com/blog/market-research/)—or at least you shouldn’t be.
...
- [Qualitative market data](#qualitative-market-data)
- [Quantitative market data](#quantitative-market-data)
...
On the other hand, I would suggest you go out and interview your (potential) customers in any situation. Even better, observe them in places your product is purchased, consumed, or discussed. Take notes on this unfiltered and unbiased information. If you have a SaaS product, you can also [record and analyze sessions](https://www.g2.com/categories/session-replay) of your users.

Here’s an example excerpt from an interview-style survey we did with our customers a while back:

If you want to get some free and solid qualitative data quickly, look into how people talk about yours and competing products on social media, forums, Slack channels, and other [online communities](https://ahrefs.com/blog/facebook-seo-groups/). It’s less reliable than conducting in-person interviews, but it’s still a fantastic qualitative data source.
...
You’ve likely filled customer surveys in various forms in the past. With the ability to conduct easy and scalable [online surveys](https://www.g2.com/categories/survey) these days, there’s really no excuse not to do them.
...
1. Make sure that you either distribute it to people who qualify as your potential customers or add survey questions to qualify them as such.
2. Have a representative sample to draw conclusions from. You can get an idea of the sample size you need by plugging your numbers into a [sample size calculator](https://www.surveysystem.com/sscalc.htm). Even if I take the whole US population into account, it only takes 600 survey participants to be 95% confident that the data is accurate within ±4%. You’ll likely need a much smaller sample.
3. Ask the right questions. I’ll expand on this.
...
This is from my [competitive analysis guide](/blog/competitive-analysis-guide/), which includes a template to help you get this done efficiently. Go check it out if you haven’t done this analysis yet.
...
1. Does your product align with what the segment wants?
2. Does it bring you the most value if you increase your market share there?
3. Do you have the sales and marketing resources to increase your market share there?
4. How difficult is it going to be to increase your market share there?
5. Does this segment influence any other segments? If so, how?
6. What are the trade-offs if you shift your focus on new segments?
...
This is from [Techradar’s reaction](https://www.techradar.com/news/wix-slams-wordpress-in-bizarre-marketing-campaign) to Wix’s campaign where they positioned themselves against WordPress. A lot of marketing and web development influencers were not impressed either:
...
>
> I still like WordPress though and it seems most of the WP community is having a good laugh. Thanks [@WordPress](https://twitter.com/WordPress?ref_src=twsrc%5Etfw) 😆 [pic.twitter.com/llpH7gNfvC](https://t.co/llpH7gNfvC)
>
> — Wes Bos (@wesbos) [April 6, 2021](https://twitter.com/wesbos/status/1379570402347864066?ref_src=twsrc%5Etfw)
...
Our [homepage](https://ahrefs.com/) immediately tells you what we do and how you can benefit from that:
...
We target the biggest segment, website owners, on our [freemium product page](https://ahrefs.com/webmaster-tools). The copy is written for SEO beginners:

It also utilizes the “versus” positioning type:

On the other hand, our product page for [Site Audit](https://ahrefs.com/site-audit) targets more seasoned marketers and SEOs:
...
You can stand out by focusing on non-visual things too. We all know [McDonald’s I’m lovin’ it jingle](https://www.youtube.com/watch?v=tfhlEP8LT4k) as an example of an auditory brand code. But you can even have your own smell, as is the case for some hotels and luxury brands.

## 5. Set strategic objectives for the year ahead

You need clearly defined [marketing objectives](https://ahrefs.com/blog/marketing-objectives/) to guide your marketing efforts and provide benchmarks for evaluation. It’s all that’s left to do for your strategy now.
...
You should have one or two marketing objectives for each of your target segments for the year ahead. That would be a part of your [marketing plan](https://www.marketingweek.com/mark-ritson-marketing-planning-14-steps/).
...
There’s an entire [publication](https://www.amazon.com/Long-Short-Balancing-Long-Term-Strategies/dp/085294134X) dedicated to this concept. The key takeaway is that brand building is proven to be the primary driver of long-term growth and success.

Here’s an example of a marketing objective with a brand-building [KPI](https://ahrefs.com/blog/marketing-kpis/):

> Increase brand awareness among webmasters in the US from 25% to 40% by the end of 2021.

Further reading

- [Marketing Objectives: How to Set Them Right (with Examples)](https://ahrefs.com/blog/marketing-objectives/)
- [7 Marketing KPIs Actually Worth Tracking](https://ahrefs.com/blog/marketing-kpis/)
- [Planning for marketing planning: 14 steps to an effective presentation](https://www.marketingweek.com/mark-ritson-marketing-planning-14-steps/)
...
Look, if you come across a new cool [marketing tactic](https://ahrefs.com/blog/marketing-tactics/) and it aligns with your strategy, sure, go ahead, give it a shot. But you’ll often find that it’s better to stick with your guns.
...
[Mark Ritson](https://twitter.com/markritson) - marketing professor, brand consultant, columnist, [Mini MBA in Marketing](https://mba.marketingweek.com/) lecturer

[Byron Sharp](https://twitter.com/ProfByron) - marketing professor and researcher, author of [How Brands Grow](https://www.amazon.com/How-Brands-Grow-What-Marketers-ebook/dp/B07Q1K1BH3)

[Peter Field](https://www.linkedin.com/in/peter-field-20110120/) & [Les Binet](https://twitter.com/BinetLes) - marketing effectiveness experts, authors of [The Long and the Short of it: Balancing Short and Long-Term Marketing Strategies](https://www.amazon.com/Long-Short-Balancing-Long-Term-Strategies/dp/085294134X)
...
Do you have any questions or remarks? Ping me on [Twitter](https://twitter.com/michalpecanek).
