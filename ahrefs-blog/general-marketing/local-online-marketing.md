---
title: "10 Local Online Marketing Tips to Grow Your Business"
source: ahrefs-blog
content_type: "blog_article"
freshness_risk: "low"
slug: "local-online-marketing"
url: "https://ahrefs.com/blog/local-online-marketing/"
canonical: "https://ahrefs.com/blog/local-online-marketing/"
author: "Mateusz Makosiewicz"
published: "2022-10-11T06:00:00+00:00"
updated: "2023-08-19T18:55:35+00:00"
categories:
  - "General Marketing"
freshness_reasons:
  - "date_2023_aging"
fetched_at: "2026-06-12T11:46:25+00:00"
status_code: 200
html_hash: "f0f52d04e3aea26bc8d336ec57534a7c32d64f91725245b61ab53ffd6b8999bd"
clean_word_count: 4982
clean_char_count: 30190
---
...
If you haven’t [created](https://www.google.com/business/) or [claimed](https://support.google.com/business/answer/4566671) your Google Business Profile (GBP) yet, make sure you do. Because here’s what people usually see when they look for something in their vicinity—a list of GBPs “recommended” by Google for a given search query.

In all, 84% of GBP visits come from discovery searches ([source](https://www.brightlocal.com/research/google-my-business-insights-study/)). This means that a striking majority of your potential customers won’t be looking for you. Rather, they’ll be looking for businesses that offer things or services they need.
...
… but an optimized GBP. One that shows accurate and helpful information and clear, useful photos. It’s a straightforward process that you can complete in [30 minutes](https://ahrefs.com/blog/google-my-business/), and it has two goals:
...
https://twitter.com/ctwtn/status/1484576953206145028

This “hack” [doesn’t work anymore](https://searchengineland.com/near-me-searches-local-seo-optimize-or-avoid-385227), at least not in Google Maps.
...
Moreover, [Google keeps adding new categories every month](https://www.sterlingsky.ca/google-my-business-category-changes/), so it’s a good idea to keep an eye on that and update your GBP accordingly. For example, if you’re a local optician offering glasses repair, you may add that category as of August 2022.
...
Just as categories, attributes are regularly updated by Google. If you want to learn more about their impact on rankings, check out this [case study](https://www.sterlingsky.ca/do-google-my-business-identity-attributes-impact-ranking/).
...
- Having said all that, since incentivized reviews are legally allowed in some circumstances, you will find platforms like Capterra, where you can offer something in return for reviews. Then the question is one of ethics and dealing with possible negative outcomes of such reviews ([here](https://blog.grade.us/online-review-incentives-2/) are three great examples of those).

Further reading

- [Legality of Paying for Online Reviews - HG.org](https://www.hg.org/legal-articles/legality-of-paying-for-online-reviews-44589)
- [It’s Unwise to Incentivize Positive Skewed Reviews | Federal Trade Commission](https://www.ftc.gov/business-guidance/blog/2019/04/its-unwise-incentivize-positive-skewed-reviews)
...
- **Use tools to gather and manage your reviews** – Check if the platform where you list your business allows for sending review requests. To make your life easier, you can use a tool for both requesting and managing reviews, such as [Podium](https://www.podium.com/) or [Birdeye](https://birdeye.com/).
- **Respond to all your comments** – The science behind that is a) according to [this study](https://hbr.org/2018/02/study-replying-to-customer-reviews-results-in-better-ratings), replying to comments can help you get better ratings and fewer short, unconstructive, and negative types of feedback and b) most customers overlook negative comments with adequate responses ([source](https://searchengineland.com/9-in-10-customers-more-likely-to-overlook-a-negative-review-if-the-business-responds-adequately-yelp-says-377004)). By the way, [it’s all right to have some negative reviews](https://tips.ariyh.com/p/-43-stars-sells-more-than-49-stars).
...
To illustrate, let’s say you offer an electronics repair shop specializing in phones, consoles, and computers in the U.K. By doing keyword research in a tool like Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer), we can discover how people search for these kinds of services.
...
1. Create a list of things related to your service, i.e., [seed keywords](https://ahrefs.com/blog/seed-keywords/); for example, an electrician may come up with these terms: wall chasing, wires, wall sockets, wiring, appliance, lighting, breaker box, etc
2. Plug them all at once in [Keywords Explorer](https://ahrefs.com/keywords-explorer)
...
For this method, you need the URL of a website with content related to your business (likely your competitor) and an SEO tool like Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer).

There’s a report in [Site Explorer](https://ahrefs.com/site-explorer) called **Organic keywords,** where you can explore keywords of any website. Along with the keywords, you will see SEO data—such as volume or Keyword Difficulty (KD)—that will help you [choose the right keywords](https://ahrefs.com/blog/how-to-choose-keywords-for-seo/).
...
You can also analyze competitors in bulk, even simultaneously comparing them to your existing content. For this, use Ahrefs’ [Content Gap tool](https://ahrefs.com/content-gap) in [Site Explorer](https://ahrefs.com/site-explorer).
...
**Recommended reading:** [*How to Write a Blog Post (That People Actually Want to Read) in 9 Steps*](https://ahrefs.com/blog/how-to-write-a-blog-post/)
...
On top of this, local citations can help you rank higher in the Google Map Pack ([source 1](https://support.google.com/business/answer/7091?hl=en#zippy=%2Cprominence), [source 2](https://ahrefs.com/seo/local-seo#local-seo-ranking-factors)).

I’m sure you already know some directories in your niche suitable for your business. You can add some more by:

- **Adding your business to big data aggregators** – For example, [Data Axle](https://local-listings.data-axle.com/search) in the U.S. The services distribute information to other websites, so being listed here can generate listings in multiple directories.
- **Using a citation list** – Like this one from [Whitespark](https://whitespark.ca/top-local-citation-sources-by-country/) or this from [BrightLocal](https://www.brightlocal.com/resources/top-business-listings-for-every-industry/).
- **Looking at your competitors’ citations** – This is something you can effortlessly do with Ahrefs’ [Link Intersect tool](https://ahrefs.com/link-intersect).
...
Because of the reasons above, you may want to consider a tool that will help you manage your listing, e.g., [Yext](https://www.yext.com/), [Uberall](https://uberall.com/en-gb), etc. Such tools offer additional, useful features like managing reviews, so you can consider the tools as longtime investments.

**Recommended reading:** [*How to Build Local Citations (Complete Guide*)](https://ahrefs.com/blog/local-citations/)
...
If you already have a website, you can check its mobile-friendliness in minutes with a free service like [Google’s Mobile-Friendly Test](https://search.google.com/test/mobile-friendly). It allows you to test one page per test, so you may need to run it a few times to test the most important pages on your website (such as homepage, services, locations, contact, etc.).

For checking website speed (both mobile and desktop), there is a whole other set of free services, such as the popular [PageSpeed Insights one from Google](https://ahrefs.com/blog/pagespeed-insights/). What’s particularly useful in this test is the use of [Core Web Vitals](https://ahrefs.com/blog/core-web-vitals/), which are part of [Google’s Page Experience signals](https://developers.google.com/search/docs/appearance/page-experience) (a ranking factor).
...
For example, [Nick Bundy](https://www.nickbundy.co.uk/) is one of the many electricians from the U.K.’s Midlands. But what sets him apart from the competition is how much you can learn about the quality of his work before you hire him.
...
1. Go to [Keywords Explorer](https://ahrefs.com/keywords-explorer) and type in keywords that define your business. For example, “bars.” Use the singular form for more results, but the plural form will usually weed out most of the branded keywords (i.e., those including the bar’s name).
...
- **Last but not least, digital media is great for** [**link building**](https://ahrefs.com/seo/link-building) – That means website visitors and an enhancement of your backlink profile, which may lead to higher rankings on the SERPs. Links from media are often sought after because of their strong link profiles.
...
You can see the strength of the profile by looking at the DR column. Star Tribune scores 88/100, which is a high score. Data via Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer).

The second method is providing expert commentary per a journalist’s request. You can monitor relevant requests through services like [HARO](https://www.helpareporter.com/), [SourceBottle](https://www.sourcebottle.com/), or [Terkel](https://terkel.io/). If you answer well enough and quickly enough, your quote may be featured along with a link to your website.

An example request delivered through email by HARO.

Further reading

- [Digital PR: The Beginner’s Guide to Making Your Brand Unmissable](https://ahrefs.com/blog/digital-pr/)
- [How to Build Backlinks and Get Press Using HARO [Case Study]](https://ahrefs.com/blog/haro-link-building/)

## Final thoughts

Local online marketing tactics seem to be focused on the promotional aspect. So speaking in terms of the classic [four Ps of marketing](https://ahrefs.com/blog/implementing-the-4-ps-of-marketing) framework, make sure you don’t neglect the other Ps— *product* (or service), *price*, and *place*—while doing *promotion*. Promotion is actually the very last step in creating an effective marketing strategy.
