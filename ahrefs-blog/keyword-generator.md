...
canonical: "https://ahrefs.com/blog/keyword-generator/"
author: "Tim Soulo"
published: "2016-11-16T10:52:02+00:00"
updated: "2025-12-18T13:53:05+00:00"
categories:
  - "Product Blog"
freshness_reasons:
  - "product_or_tool_content"
  - "time_sensitive_title"
fetched_at: "2026-06-12T11:43:40+00:00"
status_code: 200
html_hash: "aec04d8d723bdbf8c7dc0042bf4a74fccae45d5a3d204a56305ddaf0588adb9e"
clean_word_count: 4485
clean_char_count: 25509
---
# Keywords Explorer 2.0 by Ahrefs: Setting new standards for keyword research

If you’re an existing customer of Ahrefs, you’ve probably noticed our almost unhealthy obsession with [collecting the industry’s best data](/blog/ahrefs-seo-metrics/) and building industry’s best tools on top of it.
...
So after looking at the usage statistics of our [Keywords Explorer](https://ahrefs.com/keywords-explorer) tool and realizing that it is was one of the least used tools in Ahrefs, we were immediately challenged to turn things around.
...
**11.6 Billion keywords database** - Keywords Explorer 2.0 is running on an absolutely monstrous database of ~11.6 billion keywords from 200+ countries. This database is updated with fresh data every single month. To the best of my knowledge no other tool will match our size as of today. *[[Read more](#section1)]*

**Accurate “Search Volume” (Local & Global)** - we’re processing very large amounts of clickstream data, which allows us to calculate much more accurate search volumes than those in Google Keyword Planner (especially if you’re on a low spending Adwords account). *[[Read more](#section2)]*
...
Thanks to clickstream data we can see if people are actually clicking on any of the search results after performing a search. Which means we can show you quite accurately which percentage of searches result in clicks. *[[Read more](#section3)]*
...
Well, the 2.0 version of the tool with its 11.6 Billion keyword database will give you even more. *[[Read more](#section4)]*
...
This little trick gives you an idea if your keyword belongs to a broader topic and if you can rank for your keyword while actually optimising your page for this broader topic. *[[Read more](#section5)]*

**Keyword difficulty** - our KD score has already [won the first prize](https://www.authorityhacker.com/best-keyword-research-tools/) among the existing solutions. So to be honest we didn’t change anything about it in “2.0” version of Keywords Explorer. But still there are quite a few things you might want to know about it. *[[Read more](#section6)]*

**SERP overview & Positions History** - our Keyword Difficulty score is quite good, but it will never beat an opinion of an experienced SEO specialist. For that reason we have designed an all new “SERP overview” report, which brings all the core SEO metrics together to help you make educated decisions about the actual difficulty of a given SERP. *[[Read more](#section7)]*

And for a subset of the best keywords in our database we’ll also show you a cool graph with ranking history of top5 search results, which gives some extra insights about the toughness of a SERP. *[[Read more](#section8)]*

**Keyword Lists** - a very simple, but a highly requested feature. Once you come across some juicy keyword ideas, you can now save them into a list for future reference. This can be a huge time saver if you’re doing keyword research for multiple projects. *[[Read more](#section9)]*
...
There’s no point in me explaining it here, since there’s this great article by Russ Jones which does it perfectly: [“Google’s War on Data and the Clickstream Revolution”](https://moz.com/blog/clickstream-data-revolution).
...
In the [teaser video for Keywords Explorer 2.0](https://youtu.be/hmejNVY-kWU) we promised you “2.8 Billion keywords”. But at the time of writing this post we’re at 11.6 Billion already.
...
## 2. Accurate “Search Volume”

SEOs knew about the [“dirty secrets” of Google Keyword Planner](https://moz.com/blog/google-keyword-planner-dirty-secrets) for quite a while now, but this summer Google managed to surprise us (in a bad way) by limiting access to keyword data for “[advertisers with lower monthly spend](https://www.en.advertisercommunity.com/t5/AdWords-Announcements/Updates-to-the-Keyword-Planner-Tool/m-p/601961#)”.
...
The other half is that GKP is now [grouping keywords with similar meaning](http://www.thesempost.com/googles-keyword-planner-now-combines-keywords-for-search-volume/) and showing identical volumes for them:
...
Back to this very irritating [issue with keyword grouping](http://www.thesempost.com/googles-keyword-planner-now-combines-keywords-for-search-volume/). Let’s try the following keywords in GKP:
...
“WoW” here refers to [World of Warcraft](https://en.wikipedia.org/wiki/World_of_Warcraft). So it looks like people are looking for some information about the “chauffeur” character in World of Warcraft.
...
## 4. Tons of keyword ideas

With ~11.6 Billion keywords in our database (and monthly infusions of fresh ones) it’s no surprise that Keywords Explorer 2.0 will give you massive amounts of keyword ideas to sift through.

For the keyword “blogging”, the tool will give you over 35k different ideas:
...
From here, you can toggle “All” to see all keyword ideas or “Questions to see keywords phrased as questions.

So, for example, if your seed keyword is “cats”, we’ll give you keywords like:
...
You can mix and match them. For example, you can toggle “Questions” and choose between “Terms match” or “Phrase match” to see different keyword ideas.

**2. Related terms**

In this report, we show keyword ideas that are related to your seed keywords or phrases.

There are three options for you to choose from here:

- **Also rank for.** According to [our study of three million search queries](https://ahrefs.com/blog/also-rank-for-study/), the average #1 ranking page will also rank in the top10 for nearly 1,000 other relevant keywords. Turn the toggle “Also rank for” to see what these keywords are.
- **Also talk about.** See the keywords and phrases the top-ranking pages for your target keyword frequently mention. These keywords could be good sub-topics or sub-points to cover in your own content.
- **All.** Both reports combined.

For all three reports, you can choose to see keywords for the top 10 or top 100 ranking pages.

**3. Search suggestions**

In this report, we show ‘autocomplete’ suggestions for your target query and related terms.
...
In this release we didn’t change anything about our KD score. Mostly because we believe it is quite good as it is (which was also confirmed by [third party tests](https://www.authorityhacker.com/best-keyword-research-tools/)).

I have already published a pretty detailed post about our [Keyword Difficulty score and how to apply it in your keyword research](https://ahrefs.com/blog/keyword-difficulty/), but I’m still going to re-hash some of the most important points here:

### KD is based on backlink data

Ever since we first introduced our Keyword Difficulty score there has been a ton of discussion about what factors we should or should not be taking into account when calculating it.
...
We also ran [a study of 2 Million keyword searches](https://ahrefs.com/seo/on-page-seo) to investigate how different on page SEO factors correlate with Google rankings. Here’s what we learned from it:
...
So if you happen to have any suggestions of which factors we should be taking into account (and how much influence they should have on resulting KD score) please [email m](/cdn-cgi/l/email-protection#483c21253b273d24270829203a2d2e3b662b2725)e and I’ll be happy to discuss it with you.
...
Nothing beats the experience (and intuition) of a professional SEO and all we can help with at this point is bring all the SEO metrics we have to the SERP:
...
For instance, on the above screenshot you see SERP position history for “[keyword research](https://ahrefs.com/seo/keyword-research)”. Here’s another fun graph:

It’s the top 5 for the keyword “soccer”, and you can tell that the SERPs is generally unstable as pages keep entering and dropping out.
