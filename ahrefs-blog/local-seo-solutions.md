---
title: "Local SEO Solutions: 8 Tips to Boost Local Rankings"
source: ahrefs-blog
content_type: "blog_article"
freshness_risk: "low"
slug: "local-seo-solutions"
url: "https://ahrefs.com/blog/local-seo-solutions/"
canonical: "https://ahrefs.com/blog/local-seo-solutions/"
author: "Joshua Hardwick"
published: "2021-12-07T16:00:00+00:00"
updated: "2024-10-17T15:51:04+00:00"
categories:
  - "Local SEO"
freshness_reasons:
  - "date_2024_watch"
fetched_at: "2026-06-12T11:46:30+00:00"
status_code: 200
html_hash: "e80183c5b8761c182a41f46210703c40dad4b78211c253aaadaedd50505b18d7"
clean_word_count: 2958
clean_char_count: 17543
---
# Local SEO Solutions: 8 Tips to Boost Local Rankings

Local SEO is the process of increasing your business’s presence in local search to attract more customers or clients.

Plenty of guides show you [how to do local SEO](https://ahrefs.com/seo/local-seo) from start to finish. But they can be daunting, as it’s a complex subject.

So, in this guide, we’ll keep things simple with eight tips to boost local rankings:

1. [Claim and optimize your Google Business Profile](#1-claim-optimize-google-business-profile)
2. [Do local keyword research](#2-do-local-keyword-research)
3. [Optimize local landing pages](#3-optimize-local-landing-pages)
4. [Get local citations and links](#4-get-local-citations-and-links)
5. [Reclaim lost links](#5-reclaim-lost-links)
6. [Get more reviews](#6-get-more-reviews)
7. [Get featured on local list posts](#7-get-featured-on-local-list-posts)
8. [Keep your site healthy](#8-keep-your-site-healthy)
...
You can claim your business profile through [Google My Business](https://www.google.com/intl/en_uk/business/), Google’s free tool for managing your Google My Business profile.

Here’s how:

1. Go to [Google My Business](https://www.google.com/intl/en_uk/business/)
2. Click **Manage now**
...
There are lots of details and optimizations you can make here. So in the interest of keeping things simple, let’s take a look at, arguably, the five most important optimizations you should make:
...
2. **Choose the right business category** **–** You have lots of options here, and some of them are similar (e.g., accountant vs. chartered accountant). Take a minute to sift through the options and choose the most appropriate one for you.
3. **Add business hours** **–** People won’t visit or call your business if they think you’re closed, so it’s crucial to list accurate business hours. You should also do this for holiday hours so that folks know if and when you’re open during public holidays.
4. **Add photos** **–** Businesses with photos receive 42% more requests for driving directions and 35% more website clicks, [according to Google](https://web.archive.org/web/20190406054138/https://support.google.com/business/answer/6335804?hl=en). So make sure to add some.
5. **Add your website** **–** It’s surprising (and frustrating) how many business owners don’t do this. Don’t be one of them.

**Recommended reading:** *[How to Optimize Your Google My Business Listing in 30 Minutes](https://ahrefs.com/blog/google-my-business/)*
...
1. Brainstorm your products or services
2. Paste your list into Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer)
3. Go to the **Matching terms** report
4. Look for relevant keywords with search volume

For example, if we plug services like “boiler repair,” “boiler installation,” and “drain unblocking” into [Keywords Explorer](https://ahrefs.com/keywords-explorer), we see that people are searching for these and similar services every month:

Note that the search volumes in [Keywords Explorer](https://ahrefs.com/keywords-explorer) are national, not local. In other words, they show the estimated monthly number of searches in your chosen country.
...
**Recommended reading:** *[How to Do Local Keyword Research](https://ahrefs.com/blog/local-keyword-research/)*

## 3. Optimize local landing pages

If you’ve found that people are searching for the specific products or services you offer, you probably need to create [dedicated location landing pages](https://ahrefs.com/blog/location-pages/) for them.
...
1. Install and activate Ahrefs’ [SEO Toolbar](https://ahrefs.com/seo-toolbar)
2. Search Google for the service/product name + location
3. Look for a similar page to yours in the search results (this means a service page from another local business)
4. Check that it ranks for a decent number of keywords
5. Click the **KW** link
6. Filter for top 10 rankings
7. Filter out sitelink and “people also ask” rankings

For example, if we search for “boiler repair london,” we see this service page that ranks for 232 keywords:

If we click that number, we see all those keywords in Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer):
...
As we’re only interested in the most relevant keywords, let’s also filter for keywords in the top 10 and exclude sitelink and “people also ask” rankings.
...
Local citations are mentions of your business’s name, address, and phone number (NAP) online. They were voted the fifth most important ranking factor for local queries in [Moz’s 2018 study](https://moz.com/local-search-ranking-factors).

They’re likely a bit less important these days, but they’re still worth getting for two reasons:

1. **They help people find your business** **–** Local SEO is not just about optimizing for Google, but also other search engines people may use to find your business, such as Yelp, Bing, Facebook, Apple Maps, and any industry-specific directories.
2. **They may still help you to rank** **–** Even though they’re less important than they once were, they may still help you to rank.
...
Here’s how to use our [Link Intersect tool](https://ahrefs.com/link-intersect) to do this:

1. Enter your domain into [Site Explorer](https://ahrefs.com/site-explorer)
2. Click **Link intersect** on the left menu
3. Enter a few competitors
4. Click **Show link opportunities**

For example, if we do this for a plumbing company and a few of its competitors, we see many results that are clearly local or industry-specific directories:

Getting citations from these sites is usually as simple as signing up and adding your details.

**Recommended reading:** *[How to Build Local Citations](https://ahrefs.com/blog/local-citations/)*

## 5. Reclaim lost links

[Backlinks](https://ahrefs.com/blog/what-are-backlinks/) are a known Google ranking factor, but they can be difficult to build. So it’s important to ensure that none of the links you already have go to waste. You can do this by reclaiming links to pages on your site that no longer exist.

Here’s how:

1. Enter your domain into [Site Explorer](https://ahrefs.com/site-explorer)
2. Go to the **Best by links** report
3. Add a “404 not found” HTTP filter
4. Redirect those URLs to their new locations
...
To reclaim these links, all the owner of the site needs to do is redirect the old URL to the new one. You can learn how to do that in [our guide to 301 redirects](https://ahrefs.com/blog/301-redirects/).
...
Google says that “high-quality, positive reviews from your customers can improve your business visibility,” and they’re the second most important map pack ranking factor, according to [BrightLocal’s 2020 study](https://www.brightlocal.com/learn/key-ranking-factors-for-local-seo/).

How can you get more reviews? Just ask.

You have to be a little careful with this because it’s against Google’s [terms](https://support.google.com/business/answer/3474122?hl=en-GB) to offer incentives to customers in exchange for reviews. But there are ways to increase the likelihood of a customer leaving a review without breaking Google’s terms.
...
He didn’t actually ask for a review. But because the photos he took made it easier for me to leave a useful one, I did:

Judging by the number of photos on the other reviews, it looks like this approach worked well with other customers too.
...
This is a best practice, [according to Google](https://support.google.com/business/answer/3474122?hl=en-GB). So there’s no need to worry about breaking their terms here.

## 7. Get featured on local list posts

You can find “best of” lists for pretty much any product or service, no matter how obscure. Take this list of the best places to eat chicken wings in Manchester, for example:
...
1. **It gets more customers through the door** **–** These listicles usually rank high for terms like “best \_\_ in \_\_\_.”  If you’re on 9 out of 10 lists, they’re likely to try you.
2. **It gets you backlinks** **–** And we already know that backlinks help you to rank higher in Google.

Here’s how to find relevant local lists to pitch:

1. Install Ahrefs’ [SEO Toolbar](https://ahrefs.com/seo-toolbar)
2. Search Google for something that’s likely to return relevant lists for your business
3. Look for blog posts with traffic

For example, if you run a boutique hotel in London, you might search for “best boutique hotels london.” This gives you a mix of directories (which you can ignore) and blog posts. And you can see which posts get traffic by looking at the data from the [SEO Toolbar](https://ahrefs.com/seo-toolbar):
...
You can keep an eye on your site’s health with Ahrefs’ [Site Audit](https://ahrefs.com/site-audit), which you can schedule to regularly crawl your site for 100+ issues. Best of all, you can use it free of charge for your own sites by signing up for [Ahrefs Webmaster Tools](https://ahrefs.com/webmaster-tools).
...
- Orphan pages (i.e., pages without [internal links](https://ahrefs.com/blog/internal-links-for-seo/))
...
You’ll also see your site’s Health score on your Ahrefs Dashboard. This is useful for keeping an eye on your site’s health over time without the need to delve into [Site Audit](https://ahrefs.com/site-audit):

## Final thoughts

The most important part of local SEO is arguably claiming, optimizing, and attracting reviews for your Google Business Profile. This is how you’ll get more exposure from Google’s “map pack” results. Ranking higher in Google’s “regular” organic results is more about “traditional” SEO: targeting the right [keywords](https://ahrefs.com/blog/what-are-keywords/), doing [on-page SEO](https://ahrefs.com/seo/on-page-seo), and [building local backlinks](https://ahrefs.com/blog/local-link-building/).

**Looking to learn more?** Read our [beginner’s guide to local SEO](https://ahrefs.com/seo/local-seo).
