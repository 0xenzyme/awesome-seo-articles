...
canonical: "https://ahrefs.com/blog/market-research/"
author: "Mateusz Makosiewicz"
published: "2021-06-03T23:34:58+00:00"
updated: "2025-07-21T15:30:51+00:00"
categories:
  - "General Marketing"
freshness_reasons:
  - "time_sensitive_title"
fetched_at: "2026-06-12T11:47:19+00:00"
status_code: 200
html_hash: "9166c886fbaa7385bc2ac5c4635993e74ec714dc41ba8029db8369161448eb6f"
clean_word_count: 5943
clean_char_count: 37465
---
...
- [The role of market research in a marketing strategy](#role-of-market-research)
- [When to conduct market research](#when-to-conduct-market-research)
- [Types of market research](#types-of-market-research)
- [Market research methods and their benefits](#overview)
- [How to conduct market research (example included)](#how-to-do-market-research)
- [Market research tools and resources](#market-research-tools-resources)

## What is the role of market research in a marketing strategy?

A [marketing strategy](https://ahrefs.com/blog/marketing-strategy/) is a business’s overall game plan for reaching consumers and turning them into customers.
...
**Research is what marketing pros do to plan their moves, and outperform their competition.** It’s also what marketing pros use to identify the strengths and weaknesses of their own [marketing strategy](https://ahrefs.com/blog/content-marketing-strategy/).

But is market research the ultimate business oracle? Unfortunately no. Even companies that specialize in market research admit it - here’s a quote from [one of them](https://www.b2binternational.com/publications/product-development-research/):
...
1. **Setting goals**. Knowing things like the size of the market, or defining your potential customers can help you set your sales goals.
2. **Problem-solving**. Low sales? Low profitability? Market research will help you understand whether your problems are internal, like a low-quality product, or external, like aggressive competition.
3. **Supporting company growth.** Understanding how and why consumers decide on products will help you decide what products to introduce to the market.
...
Furthermore, if you’re working in startup conditions, especially if you’re developing an innovative product, you may be interested in [customer development](https://en.wikipedia.org/wiki/Customer_development). In this methodology market research is at its “agilest” and it’s tightly woven into the product development process.
...
> What was it for?
>
> — Tim Soulo (@timsoulo) [May 3, 2021](https://twitter.com/timsoulo/status/1389134975694372867?ref_src=twsrc%5Etfw)
...
- Website data (like Ahrefs’ [Web Analytics](https://ahrefs.com/web-analytics))
- CRM data
...
>
> — Tim Soulo (@timsoulo) [October 8, 2020](https://twitter.com/timsoulo/status/1314124553912684544?ref_src=twsrc%5Etfw)
...
You’d be surprised by how much you can learn about and from your competition and how much of it can be done online. There are certain tried and tested techniques, hacks, and tools for this type of research, and you can [find them in this guide](/blog/competitive-analysis-guide/).
...
The most reputable sources are [Gartner](https://www.gartner.com/en), [Forrester](https://go.forrester.com/), and [Pew](https://www.pewresearch.org/). Apart from those, make sure to check if there is a trustworthy commercial data source specific to your niche.

Sites like G2, Capterra and Trust Pilot also count. Not only do they give you an overview of your industry, but you can also find some real gems in your users’ reviews and your competitors’ reviews as well. Ahrefs uses that data source regularly internally and externally, like for this section of our [Ahrefs vs Semrush vs Moz](https://ahrefs.com/vs) landing page:
...
1. [Identify the market research problem](#identify-market-research-problem)
2. [Choose the sample and research method](#choose-sample-and-research-method)
3. [Collect the data](#collect-data)
4. [Analyze the data](#analyze-data)
5. [Interpret and present conclusions](#analyze-and-present-conclusions)

### 1. Identify the market research problem

This is where every research project starts. You will also find that market research, in general, follows the pattern of the [scientific method](https://en.wikipedia.org/wiki/Scientific_method). First, you need to establish what exactly you are researching.
...
1. **Use the entire data source**. Obviously, it’s not a sample per se. Nevertheless, if sending a survey to all of your customers is doable (and reasonable), this is a perfectly good choice.
2. **Choose a random sample.** Systematic sampling is the easiest way to choose a random sample. This is where you select every x/nth individual for the sample, where x is the population, n is the sample. For example, if you want a sample size of 100 from a population of 1000, select every 1000/100 = 10th member of the population.
3. **Use non-random sampling (the most biased).**
   1. **Convenience sampling:** choose respondents available and willing to take part in the survey.
   2. **Purposive sampling:** choose respondents that in your judgement will be representative or possess some other feature that is important to the research.
   3. **Quota sampling:** choose some arbitrary quota of respondents, e.g. 10 non-paying customers, 10 paying small companies and 10 paying large companies.
...
A word of advice, choose your market research tool carefully; it will greatly influence the amount of work you will have with analyzing the data. For example, [Google Forms](https://www.google.com/forms/about/) automatically makes graphs out of quantifiable data (plus it’s free).
...
Simple research performed on a small sample will be relatively easy to analyze, or even analyzed automatically, like with the aforementioned Google Forms. Sometimes you will have to use expensive and harder to master software like [Tableau](https://www.tableau.com/), [NVivo](https://www.qsrinternational.com/nvivo-qualitative-data-analysis-software/home), [PowerBI](https://powerbi.microsoft.com/), or [SPSS](https://www.ibm.com/analytics/spss-statistics-software). Or you can use [Python](https://www.python.org/) or [R](https://www.r-project.org/) for data analysis (if you have a data analyst or data scientist on board, you’re in luck).
...
It took us some time to [get buy-in from key stakeholders](https://ahrefs.com/blog/seo-buy-in/) and implement the conclusions throughout the whole company (eventually, we got it right). As a result, we increased sales, increased customer satisfaction and put ourselves on a more profitable growth track—a win-win for everyone. We even went as far as merging with another manufacturer to shorten the time to get to that sweet market spot.
...
- Allowing biases to influence your research ([confirmation bias](https://en.wikipedia.org/wiki/Confirmation_bias) being arguably the most common and the most dangerous one).
...
So let’s say you run a drone manufacturing brand, and you want to check out your competitors’ brand awareness in France. Go to Ahrefs [Keywords Explorer](https://ahrefs.com/keywords-explorer), input the names of the brands, select “France” as your market, and in a flash you get:
...
The only reason you were able to put all of those three phrases in the same bucket was that you knew the connection between those words. The problem is that your target audience may not know that connection; they may not even know that this kind of product exists. This quick analysis of search volume shows that you may want to make that connection, for example with [content marketing](https://ahrefs.com/blog/content-marketing/).
...
This market research quick-win ties into the broader topic of keyword research. If you want to uncover even more keyword ideas and learn how to analyze them, read[our keyword research guide](https://ahrefs.com/seo/keyword-research).
...
As I pointed out earlier, it’s one of those primary data sources that you can leverage to discover patterns in your customer behaviour or characteristics. Popular choices are Hubspot, Salesforce, Intercom, but there is a ton of CRM software out there, so check out a [software comparison like G2](https://www.g2.com/categories/crm) to see what best suits your needs.

### User feedback tools

This type of tool allows you to carry out our aforementioned survey research method online.

Create targeted, user-specific surveys and analyze answers with tools like [Google Forms](https://www.google.com/forms/about/), [SurveyMonkey](https://www.surveymonkey.com/), [Typeform](https://www.typeform.com/), or [Qualaroo](https://qualaroo.com/).
...
If you’ve never dug deeper into Google Analytics, or similar analytics software (e.g., [Matomo](https://matomo.org/), [Woopra](https://www.woopra.com/)) here are some questions that this marketing technology can answer for you:
...
If you’re already using Google Analytics, see if you’re not making these [Google Analytics tracking mistakes.](https://ahrefs.com/blog/google-analytics-tracking-mistakes/)
...
The availability of this kind of data may vary based on your target market. For example, in the US the [Census Bureau](https://data.census.gov/) offers a free resource for searching the country’s census data. You can filter the data by topics, years, geography, surveys, or industry codes. You can also access premade interactive tables (which you can also download) or simply explore certain regions of the country using their maps.

### Business intelligence tools

With business intelligence tools like [Tableau](https://www.tableau.com/), [Looker](https://looker.com/) or [Sisense](https://www.sisense.com/), you can connect to any data source to perform data cleaning, statistical operations, and data visualization. They are designed to allow you to glean insights into your data, and communicate effectively with your stakeholders. It’s like SQL combined with R, but you don’t need coding skills and you get a user-friendly interface.
...
- [Nielsen IQ](https://nielseniq.com/)
- [Think with Google](https://www.thinkwithgoogle.com/)
- [Living Facts](https://www.livingfacts.org/)
