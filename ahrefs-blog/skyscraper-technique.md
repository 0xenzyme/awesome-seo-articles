---
title: "How to Execute the Skyscraper Technique (And Get Results)"
source: ahrefs-blog
content_type: "blog_article"
freshness_risk: "low"
slug: "skyscraper-technique"
url: "https://ahrefs.com/blog/skyscraper-technique/"
canonical: "https://ahrefs.com/blog/skyscraper-technique/"
author: "Si Quan Ong"
published: "2023-02-07T02:42:57+00:00"
updated: "2025-02-17T15:38:04+00:00"
categories:
  - "Link Building"
freshness_reasons: []
fetched_at: "2026-06-12T12:10:18+00:00"
status_code: 200
html_hash: "5e9a7aec883be4e011741f031efe3e674a9c8de80602dff37cc56ad88a500adb"
clean_word_count: 2047
clean_char_count: 12410
---
...
![Three steps of the Skyscraper Technique](https://ahrefs.com/blog/wp-content/uploads/2023/02/skyscraper_technique_1.png)
...
Enter a popular site into Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer). Next, go to the **Best by backlinks** report.
...
Ahrefs’ [Content Explorer](https://ahrefs.com/content-explorer) is a searchable database of [10 billion pages](https://ahrefs.com/big-data). You can use it to find mentions of any word or phrase.

Let’s start by entering a broad topic related to your niche into [Content Explorer](https://ahrefs.com/content-explorer). Next, set a **Referring domains filter** to a minimum of 50.
...
Enter a broad keyword into Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer). Next, go to the **Matching terms** report and set a **Keyword Difficulty (KD)** filter to a minimum of 40.
...
The key to successfully executing the Skyscraper Technique is [email outreach](https://ahrefs.com/blog/email-outreach/). But instead of spamming everyone you know, you reach out to those who have already linked to the **specific content you have improved.**

The assumption: Since they’ve already linked to a similar article, they’re more likely to link to one that’s better.

You can find these people by pasting the URL of the original piece into Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer) and then going to the **Backlinks** report.
...
https://twitter.com/justdebbb/status/1479110232869457925

So we asked our [Twitter](https://twitter.com/ahrefs/status/1616284470067298304) and [LinkedIn following](https://www.linkedin.com/posts/ahrefs_link-builders-we-want-to-know-what-you-think-activity-7021730502004932608-qvG0?utm_source=share&utm_medium=member_desktop) this question and received 1,242 votes. Here are the results:

Clearly, many SEOs and marketers still believe the technique works.

Sidenote.

According to Aira’s annual [State of Link Building report](https://aira.net/state-of-link-building/link-building-techniques-and-tools/), **only** 18% of SEOs still use the Skyscraper Technique. It’s not a go-to for many SEOs, as it ranks #20 among the list of tactics. I suspect its popularity has waned because (1) it’s old and SEOs are looking for newer stuff and (2) SEOs believe that content is more important than links these days.
...
I’m not saying this to disparage templated emails. If you’re sending something at scale, templating is necessary. But move away from this template. Write your own, personalize it as much as possible, and follow the [outreach principles here](https://ahrefs.com/blog/outreach/).
...
Consider dividing your list of prospects into segments according to the context in which they linked. You can do this by checking the **Anchors** report in [Site Explorer](https://ahrefs.com/site-explorer).

You can clearly see people are linking to different statistics from our [SEO statistics post](https://ahrefs.com/blog/seo-statistics/). So, for example, if we were doing outreach for a hypothetical post, we might want to mention to the first group that we have a new statistic for “Over 90% of content gets no traffic from Google.”
...
To find these pages, enter the target keyword into [Keywords Explorer](https://ahrefs.com/keywords-explorer) and scroll down to the **SERP overview.**
...
Looking for even more prospects? Use [Content Explorer](https://ahrefs.com/content-explorer).
...
Example: My colleague, [Chris Haines](https://twitter.com/chris_at_b449), recently published a [post on the best niche site ideas](https://ahrefs.com/blog/niche-site-ideas/). Even though he only included 10, he has already outperformed the other “skyscraper” articles:
...
As Ross Hudgens [says](https://www.siegemedia.com/seo/skyscraper-technique), “Better does not occur in a branding vacuum.”

Most of the time, content isn’t judged solely on its quality. It’s also judged by who it comes from. We [discovered this ourselves](https://ahrefs.com/blog/email-outreach/) too when we tried to build links to our [keyword research guide](https://ahrefs.com/seo/keyword-research).
...
Keep on [making great content](https://ahrefs.com/blog/how-to-write-great-content/)—skyscraper or not—and results will come if you trust the process.
...
> - 5-star content with a strong USP
> - Good, established brand
> - Unique template that doesn’t look like what everyone else is using
>
> — Alan Silvestri (@AlanGGorilla) [January 20, 2023](https://twitter.com/AlanGGorilla/status/1616444655310344208?ref_src=twsrc%5Etfw)
