---
title: "How Long Should Blog Posts Be? (The 'Truth')"
source: ahrefs-blog
content_type: "blog_article"
freshness_risk: "low"
slug: "blog-post-length"
url: "https://ahrefs.com/blog/blog-post-length/"
canonical: "https://ahrefs.com/blog/blog-post-length/"
author: "Joshua Hardwick"
published: "2020-07-14T16:00:40+00:00"
updated: "2024-09-17T11:14:04+00:00"
categories:
  - "Content Marketing"
  - "On-Page SEO"
freshness_reasons:
  - "date_2024_watch"
fetched_at: "2026-06-12T11:19:02+00:00"
status_code: 200
html_hash: "546aaa4ef645563a4cb6895dcf3a8a9e815c8dca24e8b8647260925e4d4e7ca6"
clean_word_count: 1867
clean_char_count: 11147
---
...
From there, hitting a certain [word count](https://wordcount.com/) shouldn’t be your aim. Your aim should be to write a thorough, engaging, and well-researched post that’s as long as it needs to be: no less and no more.
...
[Backlinks](https://ahrefs.com/blog/what-are-backlinks/) are one of the most important Google [ranking factors](https://ahrefs.com/blog/google-ranking-factors/).

We know this because they’re the foundation of the [PageRank](https://ahrefs.com/blog/google-pagerank/) algorithm. Google also talks about backlinks in the context of ranking useful pages [here](https://www.google.com/intl/en_uk/search/howsearchworks/algorithms/).

If you look at the relationship between word count and backlinks, there is indeed a strong positive correlation.

In this case, the data comes from analyzing a sample of around 900 million pages from the 3+ billion pages [Content Explorer](https://ahrefs.com/content-explorer). That’s our content research tool for analyzing the best-performing content about a topic. However, we’re not the first to see this correlation. Many people have analyzed other data sources and found the same thing: longer content gets more backlinks than shorter content.
...
One way is to paste the URL of a top-ranking post for your target keyword into [Ahrefs’ Site Explorer](https://ahrefs.com/site-explorer). Then, head to the **Backlinks** report and look at the links anchors and surrounding text for trends.
...
That’s what we did in [our SEO copywriting guide](https://ahrefs.com/blog/seo-copywriting/). We didn’t want to copy the other post and mention the APP method, so we mentioned another useful intro formula instead.
...
According to our analysis of the pages in [Content Explorer](https://ahrefs.com/content-explorer), there’s a moderate positive correlation between content length and organic traffic.

But again, it’s unwise to assume causation.

#### Why might you see this correlation?

Let’s first consider the idea that Google is biased towards longer content. As a result, longer content [ranks higher](https://ahrefs.com/blog/how-to-rank-higher-on-google/) and gets more organic traffic.
...
Google’s John Mueller agrees. In 2019, he [stated](https://www.reddit.com/r/bigseo/comments/clg1hn/how_to_find_word_count_in_serp/) that word count isn’t a ranking factor.
...
Second, longer content tends to be more thorough and naturally covers more subtopics. For that reason, longer content often ranks for more [long-tail keywords](https://ahrefs.com/blog/long-tail-keywords/).

Just take [our list of Google search operators](https://ahrefs.com/blog/google-advanced-search-operators/). According to Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer), it ranks for around 7,200 keywords.
...
You can also [run a content gap analysis to find keywords](https://ahrefs.com/blog/content-gap-analysis/) that multiple top-ranking pages rank for, then eyeball the report for subtopics and important points. To do this, paste the URLs of a few top-ranking pages for your main keyword into Ahrefs’ [Content Gap tool](https://ahrefs.com/content-gap) and leave the bottom field empty.
...
## Why blog posts should be as succinct as possible
...
Absolutely. When Medium [studied](https://medium.com/data-lab/the-optimal-post-is-7-minutes-74b9f41509b) the correlation between post length and average reading time, they noticed that engagement starts to drop for posts with a reading time longer than seven minutes.

According to [The University of Chicago](https://web.archive.org/web/20180307083117/https://wellness.uchicago.edu/page/speed-reading/), most people read at approximately 250 words per minute. That puts a 7-minute blog post at around 1,750 words.

Does that mean your blog posts should never be any longer or shorter than that?

Of course not. It will take more than 1,750 words to tackle some topics thoroughly and less for others. That’s why [our guide to YouTube SEO](https://ahrefs.com/blog/youtube-seo/) runs over 7,000 words, and [our list of Chrome extensions for SEOs](https://ahrefs.com/blog/seo-chrome-extensions/) runs just 1,275. There’s more ground to cover about YouTube SEO.

Screenshot from [Ahrefs’ Content Explorer.](https://ahrefs.com/content-explorer)
...
One of the tools that can help with that is [Hemingway](http://www.hemingwayapp.com/). It helps to [improve your writing](https://ahrefs.com/blog/writing-tips/) by letting you know about unnecessary words and fluff. In my experience, it’s easy to cut your word count down by at least 10% using this tool. But then again, it might just be that my writing style is unusually convoluted.
...
It’s time to stop the obsession with word count. Instead, focus on creating concise but thorough blog posts that engage readers and follow [SEO best practices](https://ahrefs.com/blog/seo-best-practices/).

Struggling with the engagement part? Take a look at [these SEO copywriting tips](https://ahrefs.com/blog/seo-copywriting/).
