...
slug: "ahrefs-enterprise-new-features"
url: "https://ahrefs.com/blog/ahrefs-enterprise-new-features/"
canonical: "https://ahrefs.com/blog/ahrefs-enterprise-new-features/"
author: "Rebekah Bek"
published: "2023-09-12T00:44:14+00:00"
updated: "2023-12-11T03:45:20+00:00"
categories:
  - "Product Blog"
freshness_reasons:
  - "date_2023_aging"
  - "product_or_tool_content"
fetched_at: "2026-06-12T11:11:29+00:00"
status_code: 200
html_hash: "819fe73c51f786cb85fd9d0886d7934cc114f7e00007a35ccaea1cd11e2a1a61"
clean_word_count: 2042
clean_char_count: 12876
---
# Ahrefs Enterprise: New features and highlights

Ahrefs Enterprise has been around for a while now, and we’ve greatly expanded our capabilities in four core areas:
...
![Grow SEO performance with Ahrefs Enterprise](https://ahrefs.com/blog/wp-content/uploads/2023/09/ent-test.png)
...
### **D****edicated Enterprise support**

To make the process of evaluating, purchasing and integrating Ahrefs as simple and seamless as possible, you’ll have a dedicated Ahrefs consultant who works directly with you to:

- Evaluate if Ahrefs is the right fit for your complex business requirements
- Provide a tailored demo to fit your unique use cases
- Help build a business case
- Share what reporting would look like and how to integrate Ahrefs with your existing systems
- Provide a trial for your team
- Navigate purchasing Ahrefs
- Guide your team on account set-up best practices
- Guide your team on leveraging Ahrefs to get the most value as quickly as possible

To learn more about Ahrefs Enterprise, [fill out this form](https://ahrefs.com/signup?interval=monthly&plan=enterprise) and our team will be in touch.
...
[Site Explorer](https://docs.ahrefs.com/docs/api/site-explorer)
...
[Keywords Explorer](https://docs.ahrefs.com/docs/api/keywords-explorer)
...
[SERP Overview](https://docs.ahrefs.com/docs/api/serp-overview)
...
[Go to Opportunities report >](https://app.ahrefs.com/v2-site-explorer/opportunities?mode=subdomains&target=ahrefs.com)
...
- **Create author-specific portfolios** if you have multiple authors publishing content on your website. This lets you see which of your authors are bringing more search traffic and backlinks, which ones have a higher publishing pace, and so on.
...
[Go to Portfolios >](https://app.ahrefs.com/dashboard/portfolios?portfolioPeriod=30&portfolioSort=newest-first)
...
[Go to Calendar report >](https://app.ahrefs.com/v2-site-explorer/calendar?calendarSelectEnd=2023-09-04&calendarSelectStart=2023-08-29&changeType=declined%7C%7Cimproved%7C%7Clost%7C%7Cnew&keywordRules=&limit=50&mode=subdomains&month=9&offset=0&positionChanges=&serpFeatures=&sort=trafficChanges&sortDirection=desc&tab=positions&target=ahrefs.com%2F&urlRules=&volume_type=average&year=2023)
...
Did you know that Site Audit is 100% customizable? Click on Issue settings and you’ll be able to toggle specific issues off, either globally and for certain websites. If there’s an issue that’s irrelevant to your website, you can customize your health score this way. [Learn more](https://help.ahrefs.com/en/articles/1420169-how-to-configure-pre-set-issues-within-ahrefs-site-audit)
...
Did you know that in Ahrefs, you can track Google Search Console data **over** **16 months old** ? In Google Search Console itself, data is only kept for the last 16 months.
...
[Go to GSC overview >](https://app.ahrefs.com/rank-tracker/gsc-overview/2278974?aggregation=daily&country=all&ctrPositionTicks=10&daysBack=all&search=web)
