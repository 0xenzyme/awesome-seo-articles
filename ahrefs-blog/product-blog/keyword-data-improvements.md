---
title: "Ahrefs’ Keyword Data: More Coverage, Accuracy, and Utility Than Ever Before"
source: ahrefs-blog
content_type: "product_blog"
freshness_risk: "low"
slug: "keyword-data-improvements"
url: "https://ahrefs.com/blog/keyword-data-improvements/"
canonical: "https://ahrefs.com/blog/keyword-data-improvements/"
author: "Tim Soulo"
published: "2022-02-10T10:01:28+00:00"
updated: "2024-02-02T17:25:52+00:00"
categories:
  - "Product Blog"
freshness_reasons:
  - "date_2024_watch"
  - "product_or_tool_content"
fetched_at: "2026-06-12T11:43:35+00:00"
status_code: 200
html_hash: "e134aff70cc6b351de5716bae40a203bcc670a3eef6db30d018106b9247ce81d"
clean_word_count: 1262
clean_char_count: 8006
---
# Ahrefs’ Keyword Data: More Coverage, Accuracy, and Utility Than Ever Before
...
An empty search in [Keywords Explorer](https://ahrefs.com/keywords-explorer) gives you access to our entire keyword database (in the selected country).
...
I also had to exclude outliers like “covid” or “NFT,” where Ahrefs showed 64X and 24X more keyword ideas, respectively.
...
We worked hard to refine our search volume numbers by blending data from multiple sources and finding the right balance between them. We’ve also started showing the monthly search volume values for each keyword, with an option to export them into CSV.

But how accurate are the search volumes in Ahrefs?

Well, we recently performed [a study of 72,635 random keywords](https://ahrefs.com/blog/gsc-gkp-search-volume-study/) comparing the search volumes from three sources: Ahrefs, Google Keyword Planner, and Google Search Console.

And it turned out that **the search volumes in Ahrefs are more accurate than search volumes in Google Keyword Planner** (when compared to “Impressions” from Google Search Console)*.*

One of the main reasons why Ahrefs has better search volumes than [Google Keyword Planner](https://ahrefs.com/blog/google-keyword-planner/) is the latter is known for [grouping search queries with similar meaning](http://www.thesempost.com/googles-keyword-planner-now-combines-keywords-for-search-volume/) and showing an aggregated search volume for the entire group.
...
But here at Ahrefs, we have developed a unique algorithm for modeling keyword search volumes that blends data from multiple sources (including clickstream). This allows us to “un-group” keyword clusters from Google Keyword Planner and display a search volume for each keyword:

Seeing the distinct search volumes for close keyword variations prevents you from accidentally overestimating a topic’s total search traffic potential when summing the search volumes of all keywords in a group (also known as [keyword clustering](https://en.wikipedia.org/wiki/Keyword_clustering)).
...
**[Pages don’t rank for a single keyword!](https://ahrefs.com/blog/also-rank-for-study/)**
...
>
> — Kevin\_Indig (@Kevin\_Indig) [July 14, 2020](https://twitter.com/Kevin_Indig/status/1283024362237497344?ref_src=twsrc%5Etfw)
...
This simple workflow inspired us to add a brand-new metric to Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer): **Traffic Potential**.
...
The keyword *“*submit website to search engines” has a pretty small monthly search volume of 450 in the U.S., but its **Traffic Potential** is 4.6K.
...
> 🔥 Traffic potential 🔥
>
> Because pages don’t rank in Google for just a single keyword. They also rank for all the different variations of that keyword and get search traffic from them. <https://t.co/a0ehTT5WJV> [pic.twitter.com/zQAXCaQTYj](https://t.co/zQAXCaQTYj)
>
> — Tim Soulo 🇺🇦 (@timsoulo) [November 12, 2021](https://twitter.com/timsoulo/status/1458975097067229191?ref_src=twsrc%5Etfw)
