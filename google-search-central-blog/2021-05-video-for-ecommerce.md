---
title: "Video SEO best practices for ecommerce"
source: google-search-central-blog
content_type: "blog_article"
freshness_risk: "historical"
slug: "2021-05-video-for-ecommerce"
url: "https://developers.google.com/search/blog/2021/05/video-for-ecommerce"
canonical: "https://developers.google.com/search/blog/2021/05/video-for-ecommerce"
author: "Alan Kent"
published: "2021-05-12T00:00:00+00:00"
updated: "2021-05-12T00:00:00+00:00"
categories:
...
fetched_at: "2026-06-14T13:39:09+00:00"
status_code: 200
html_hash: "10e7b16f85408d3071cd981ced7dbc03e9d603b660cc7a36806a4c025fac06d6"
clean_word_count: 869
clean_char_count: 5464
---
# Video SEO best practices for ecommerce

Video is becoming increasingly common on ecommerce sites. As a site owner, you can use video to
give shoppers a deeper understanding of products you sell or build your reputation as a trusted
expert. Video can also be prominent in Google Search. By surfacing your video content on Google,
you can open up additional paths of discovery to drive awareness of your business and engagement
on your site.

## Where videos can appear in Google Search results

Videos can appear on the main Google Search results page or on the Videos tab. Videos are frequently
presented with a thumbnail image and other helpful information such as the playback duration and
summary text. In addition, Google can now highlight
[key moments](/search/docs/appearance/video#key-moments)
in your video content, allowing users to navigate the video like chapters in a book.
When a user taps a key moment, they'll land on
your site where they can begin watching the video from that moment in time.

![Google Search results page with a video, demonstrating how key moments are displayed.](/static/search/blog/images/video-for-ecommerce-1.gif)
...
- Include [`Video` structured data](/search/docs/appearance/structured-data/video)
...
- For those videos that you want to give maximum exposure to, consider creating a page dedicated to the
  ...
  the product page.
- ![Example of how the LIVE badge appears on videos in Google Search results.](/static/search/blog/images/video-for-ecommerce-2.png)
  For live streams, include structured data to enable
  [LIVE badges](/search/docs/appearance/video#live-badge),
  which can help draw attention to the streams when they go live. Use the
  [Indexing API](/search/apis/indexing-api/v3/quickstart)
  to provide Google with timely updates when a stream starts and ends. A live stream recording
  made available for viewing after the live event is not eligible for the LIVE badge.
- Create and submit a
  [video sitemap file](/search/docs/crawling-indexing/sitemaps/video-sitemaps) to help Google
  find all your web pages with video content.
- In addition to `Video` structured data, consider adding structured data that's
  relevant for each page, such as
  [`Product`](/search/docs/appearance/structured-data/product),
  [`HowTo`](/search/docs/appearance/structured-data/how-to), or
  [`Q&A`](/search/docs/appearance/structured-data/qapage) markup.

For more information, check out
[these new
resources](/search/blog/2021/03/new-resources-for-video-seo) that give an overview of how videos appear on Google, including
[best practices](/search/docs/appearance/video)
