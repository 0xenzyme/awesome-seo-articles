---
title: "How to Get a Job in SEO"
source: ahrefs-blog
content_type: "blog_article"
freshness_risk: "low"
slug: "how-to-get-a-job-in-seo"
url: "https://ahrefs.com/blog/how-to-get-a-job-in-seo/"
canonical: "https://ahrefs.com/blog/how-to-get-a-job-in-seo/"
author: "Chris Haines"
published: "2022-11-14T06:00:00+00:00"
updated: "2024-05-23T15:30:16+00:00"
categories:
  - "General SEO"
freshness_reasons:
  - "date_2024_watch"
fetched_at: "2026-06-12T11:38:04+00:00"
status_code: 200
html_hash: "6f924f73bcd54ae702d3c5957cfa94ce5f3733974a74326879cfc0c0f1895bc9"
clean_word_count: 2310
clean_char_count: 13321
---
# How to Get a Job in SEO

I’ve worked in SEO for 10 years in different agencies. And in that time, I have reviewed many different resumes as a hiring manager.

I’ve also interviewed lots of exceptional candidates and some not-so-great candidates for SEO roles. So what exactly does it take to get a job in SEO? And what separates the exceptional candidates from the not-so-great candidates?
...
## Step 1. Learn the SEO basics (No, you don’t need to go to college)
...
So what are the [SEO basics](https://ahrefs.com/seo/seo-basics) you need to know?

To start off, I recommend that you take a look at our [SEO beginner’s video course](https://app.ahrefs.com/academy/seo-training-course/lesson-0-1). Or if you prefer reading to watching, make sure you check out our [beginner’s guide to SEO](https://ahrefs.com/seo).
...
If at any point you don’t know what some of the harder-to-decipher SEO terms mean, you can always check our [SEO glossary](https://ahrefs.com/seo/glossary), which provides the definitions of SEO terminology.
...
**Learn more:** [*10 Google Sheets Formulas Every SEO Should Know*](https://ahrefs.com/blog/google-sheets-formulas-seo/)
...
Luckily, this is the first thing [our Academy course teaches](https://ahrefs.com/academy/seo-training-course).
...
If you don’t have any prior work experience with another SEO company, then showing that you have taken the initiative to set up a website and [rank it for certain keywords](https://ahrefs.com/blog/how-to-rank-higher-on-google/) is a good way to show your passion and interest in SEO.
...
## Step 3. Familiarize yourself with Google Search Essentials (formerly Webmaster Guidelines)

The search market is still dominated by Google. So if you work in SEO, you need to be familiar with the rules of the game.

Carefully digest the [Google Search Essentials (formerly Webmaster Guidelines)](https://developers.google.com/search/docs/advanced/guidelines/overview) and work within the guidelines. (If you suggest SEO strategies that are against Google Search Essentials guidelines, then a hiring manager will almost certainly turn you down.)

## Step 4. Make your SEO resume stand out from the crowd
...
In days gone by, submitting your Microsoft Word resume would have been sufficient. But these days, tools such as [Canva](https://www.canva.com/resumes/templates/) can help you make a professional-looking resume that looks great. (Yes, it is totally free.)

### Tip 3. Use a professional email address

Unfortunately, I still see many [stories on social media](https://twitter.com/JoyDoreenBiira/status/1419697904302841858?s=20&t=VYIn4aeqJCYU3yfj10pQlQ) of hiring managers rejecting resumes due to their inappropriate email addresses. Don’t be one of them!

https://twitter.com/joydoreenbiira/status/1419697904302841858?s=61&t=RJA0NyXvL8M4VEiwwvuQjw

### Tip 4. Avoid resume cliches

Try to avoid using buzzwords or [cliches](https://www.linkedin.com/business/talent/blog/product-tips/words-you-should-not-use-on-linkedin-profile-infographic) in your resume.

## Step 5. Apply for a job at an SEO agency
...
You can apply to SEO agencies in your location and also set up [indeed.com job alerts](https://support.indeed.com/hc/en-gb/articles/204488890-How-to-create-a-Job-Alert) to be notified about new jobs with your search terms so you have relevant opportunities sent to your inbox.

Recommendation

If you find an agency that you like the look of but it doesn’t currently have any job openings on its website, you can use a tool such as [Distill.io](https://distill.io/) to track any changes on its “jobs” landing page. So in the event that the agency does update the job listings on that page in the future, you will be the first to know either through an SMS notification or by email.

It’s worth noting that the naming conventions of entry-level SEO positions can vary quite a lot.

On indeed.com, I found that the most relevant jobs were classed as “SEO Intern” or “[SEO Graduate](https://www.indeed.com/jobs?q=SEO%20Graduate&from=sug&vjk=d4fadc91fbac0211),” so you will need to apply for these roles. (If you are outside of the U.S., naming conventions may differ.)
...
THE SEO AGENCY CAREER PATH IN A NUTSHELL

You may be wondering what is the typical career path following the SEO intern/graduate stage.
...
## Step 6. Prepare for the interview and get an offer
...
1. **Install popular video conferencing software** – Download Microsoft Teams, Zoom, and Google Meet. Then familiarize yourself with the interfaces beforehand. (Avoid the “Sorry, I was on mute” scenario!) Run a test call to check your mic and webcam are working properly and that the room is well lit. If you are using wireless headphones, make sure they are suitably charged.
2. **Look professional** – If you have two screens, remember to focus on the screen with the camera on it to avoid the look that you are not paying attention to what the hiring manager is saying.
3. **Be prepared to accept tasks** – As [algorithms can change a lot in SEO](https://ahrefs.com/google-algorithm-updates), many hiring managers are looking for [experiential learners](https://www.wgu.edu/blog/experiential-learning-theory2006.html) or, in simpler terms, people who can learn “by doing.” Be aware that some hiring managers may set tasks for you.
4. **Check the company’s website** – A quick glance at the company’s website beforehand and checking out its latest social media posts can mean that you know exactly what its focus is.
5. **Check SEO interview questions on Google** – A bit of Googling beforehand around “SEO interview questions” will also help you understand the types of questions you are likely to get in the interview.
6. **Ask questions** – At the end of the interview, the hiring manager will ask if you have any more questions about the role. This is a good opportunity to ask how long it will take to hear back from them on whether you have been successful.
...
1. The introduction.
2. “Please talk me through your resume.”
3. “What would you do in terms of [SEO strategy](https://ahrefs.com/blog/orchard-seo-strategy/) for X website?” (The website is typically the company’s own site or a client’s.)
...
“You mentioned that you optimized your website for site speed and [Core Web Vitals](https://ahrefs.com/blog/core-web-vitals/). How exactly did you do that?” (Typically, a hiring manager at an agency will be mostly concerned with their biggest client’s market, e.g., maybe it is e-commerce.)
...
I hope you found this guide helpful and that you end up getting the job. (Let me know if you do!) Got more questions? Ping me [on Twitter](https://twitter.com/chris_at_b449). 🙂
