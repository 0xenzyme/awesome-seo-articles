...
canonical: "https://ahrefs.com/blog/seo-reporting/"
author: "Chris Haines"
published: "2024-02-19T14:33:23+00:00"
updated: "2025-07-21T16:04:52+00:00"
categories:
  - "General SEO"
freshness_reasons: []
fetched_at: "2026-06-12T12:07:40+00:00"
status_code: 200
html_hash: "b5e7e6a80ee4dce89643e9636666acca79a27f46d64b69f5fd1be7fbcb5e0f28"
clean_word_count: 2733
clean_char_count: 16244
---
...
![](https://ahrefs.com/blog/wp-content/uploads/2024/02/word-image-172326-1.png)

### 1. Data-led

Good SEO reports are grounded in [high-quality data](https://ahrefs.com/big-data). You need to get as close to the “truth” as possible. The good news is that you can get all the information you need from some free tools.

- [Google Search Console](https://search.google.com/search-console/about) (also referred to as GSC, GWT, or Webmaster Tools)
- [Ahrefs’ Webmaster Tools](https://ahrefs.com/webmaster-tools) (also referred to as AWT)
- [Google Analytics](https://marketingplatform.google.com/intl/en_uk/about/analytics/) (also referred to as GA)
- [Ahrefs’ Web Analytics](https://ahrefs.com/web-analytics) (a simple, privacy-friendly alternative to GA)
...
Original image source: https://cdn.teachstarter.com/fileserver/2021/02/Modality.jpg
...
And here’s another example of [Site Explorer](https://ahrefs.com/site-explorer) **Overview** showing YoY performance:
...
- There was a [Google algorithm update](https://ahrefs.com/google-algorithm-updates) at {date} that impacted our organic search traffic
...
You can use various [keyword tracking tools](https://ahrefs.com/blog/keyword-tracking-tools/) to do this, but you’ll need a tool like [Rank Tracker](https://ahrefs.com/rank-tracker) to regularly track your keyword rankings.

Let’s see how we can include these elements in our report using [Rank Tracker.](https://ahrefs.com/rank-tracker)
...
On the same dashboard, you can get the headline metrics like [share of voice](https://ahrefs.com/blog/share-of-voice/), average position, and SERP features.
...
Luckily, Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer) can help you report on both elements.
...
To find the number of links acquired from the last calendar period, do the following in [Site Explorer](https://ahrefs.com/site-explorer):
...
Here’s an example of a [high-quality link](https://ahrefs.com/blog/high-quality-backlinks/) Ahrefs.com acquired during this period. It has a domain rating (DR) of 93. This is the type of link that would be worth sharing in an SEO report.
...
If we click on that link, we see they’re linking to our [SEO basics](https://ahrefs.com/seo/seo-basics) article.
...
To answer this question, you can run a [Site Audit](https://ahrefs.com/site-audit) crawl and check the [website health score](https://help.ahrefs.com/en/articles/1424673-what-is-health-score-and-how-is-it-calculated-in-ahrefs-site-audit).

Tip

If you have access to Google Search Console, you can run a Site Audit for free on your website. [Click here to get started](https://ahrefs.com/site-audit).

[Site Audit](https://ahrefs.com/site-audit) scores your website from 0-100 after the crawl based on its technical SEO health status. If the score is low, it means there are some technical issues to be fixed.

As well as running a Site Audit crawl, you can check in GSC to see if there are any technical issues with page indexing or page experience (like [core web vitals](https://ahrefs.com/blog/core-web-vitals/) or HTTPs).
...
For smaller content projects that have less than 1000 URLs, you can use [**Portfolios**](https://ahrefs.com/portfolios) to track these keywords.
...
You can do this in 30 seconds by heading to [Site Explorer](https://ahrefs.com/site-explorer) and typing in your competitor in the search bar.
...
- **Low-hanging fruit keywords**: shows keywords between positions 4-15 in [Site Explorer](https://ahrefs.com/site-explorer) that could be easy to rank for.
- **Featured snippets**: shows keywords between positions 2-8 in [Site Explorer](https://ahrefs.com/site-explorer) where the target doesn’t rank for a featured snippet
...
The best way to do this is to share progress through an [SEO roadmap](https://ahrefs.com/blog/seo-roadmap/) Gantt chart showing your total SEO campaign.

Rather than messing around with a spreadsheet, I usually head to [Canva](https://www.canva.com/templates/?query=gantt-chart) and use one of their premade templates.

But if you want to go down the spreadsheet route, you can use our [Google Sheets template](https://docs.google.com/spreadsheets/d/1i9Er8IFnf4Wg0dLN8tIlcuQAtJaeLj9jI6ESI53q_qw/copy).
