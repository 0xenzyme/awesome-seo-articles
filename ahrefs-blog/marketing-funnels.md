---
title: "The Marketing Funnel: What It Is, How It Works, & How to Create One"
source: ahrefs-blog
content_type: "blog_article"
freshness_risk: "low"
slug: "marketing-funnels"
url: "https://ahrefs.com/blog/marketing-funnels/"
canonical: "https://ahrefs.com/blog/marketing-funnels/"
author: "Si Quan Ong"
published: "2023-07-17T05:01:24+00:00"
updated: "2024-10-17T15:59:13+00:00"
categories:
  - "General Marketing"
freshness_reasons:
  - "date_2024_watch"
fetched_at: "2026-06-12T11:48:01+00:00"
status_code: 200
html_hash: "8282c78027bdeb1582785999d1e815af115f9dedb6b3261b96d87d38a8c3f5d9"
clean_word_count: 3095
clean_char_count: 19367
---
...
![The marketing funnel](https://ahrefs.com/blog/wp-content/uploads/2023/07/marketing-funnels-1-2.png)
...
The marketing funnel (also known as the purchase funnel or sales funnel) is based on the Awareness-Interest-Desire-Action (AIDA) model, first developed [in 1898](https://en.wikipedia.org/wiki/Purchase_funnel) by E. St. Elmo Lewis, an advertising advocate.
...
For example, they may watch a few more of your videos, subscribe to your YouTube channel, check your social media posts, browse your website, and even sign up to your email list.
...
Just because they know who you are and what you do doesn’t mean you’re their final choice. They’ll evaluate alternatives, read reviews, look at customer testimonials, talk to friends and family, and compare.

For example, Ahrefs estimates hundreds of monthly searches for Talisker whiskey reviews:

### 4. Action

The Action stage (also known as the Conversion stage) is when your prospective customers have decided they’re going to buy from you. They’re one step away from becoming paying customers.
...
Therefore, the marketing funnel simplifies the [customer journey](https://ahrefs.com/blog/buyers-journey/) and serves as a mental model for businesses to tweak their marketing strategy. You’ll be able to ensure you’re executing [marketing tactics](https://ahrefs.com/blog/marketing-tactics/) at each marketing funnel stage.

Without this intentional focus, some stages of your marketing funnel will get neglected and you’ll end up with “holes” that cause you to be losing customers (i.e., a “leaky” funnel).
...
Practically speaking, “creating” a marketing funnel means executing marketing strategies at different stages. To make implementing marketing campaigns easier, many marketers further simplify the funnel into three stages:

- **Top of the funnel (TOFU)** – Awareness.
- **Middle of the funnel (MOFU)** – Interest.
- **Bottom of the funnel (BOFU)** – Desire and Action.

Here are the tactics you can implement in each stage of the funnel:

### 1. Top of funnel (TOFU)

The top of the funnel is the Awareness stage. Your goal is to “open up the funnel,” i.e., introduce your brand to as many relevant people as possible and attract prospects..
...
In the Awareness stage, you’ll want to create content targeting keywords that your target audience are likely to be searching for early in their journey.
...
As you can see, people in the Awareness stage don’t know we exist. In fact, they may not even know SEO is the solution to their problem. Instead, they may be searching for something broader, like [how to get traffic to their website](https://ahrefs.com/blog/how-to-drive-traffic-to-your-website/).
...
2. Enter top-of-the-funnel terms (for Ahrefs, it’ll be keywords like “blog traffic” and “website traffic”)
...
For example, our chief marketing officer, [Tim Soulo](https://twitter.com/timsoulo), appears on podcasts frequently:

https://www.youtube.com/watch?v=7d5HVT6kgU0

Here’s how you can find potential podcast opportunities:

1. Find a prolific podcast guest in your industry
2. Go to Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer)
3. Enter their domain
4. Go to the **Backlinks** report
5. In the “Referring page title” filter, look for “episode”

![How to find podcast opportunities, via Ahrefs' Site Explorer

Podcast appearances aren’t the only way. You can appear on a webinar, present at a conference, write a [guest post](https://ahrefs.com/blog/guest-blogging/), or co-create content.

#### Ads

Whether it’s YouTube ads or sponsorships, thousands of brands have been built using ads.

Paid ads are one of the most tried and tested tactics for [building brand awareness](https://ahrefs.com/blog/increase-brand-awareness/).

If you have the budget, it’s a great way to generate eyeballs for your brand.

Further reading

- [Top-of-the-Funnel Marketing Explained: How to Attract Customers](https://ahrefs.com/blog/top-of-the-funnel/)

### 2. Middle of funnel (MOFU)

The middle of the funnel is the Interest stage. Your goal of [MOFU content](https://ahrefs.com/blog/mid-funnel-content/) is to capture their interest, nurture it, and convince them you’re the right product for the job.

Here are some tactics to do that:

#### Target MOFU keywords

In this stage, our target customers know what SEO is. They also know they need an SEO tool.
...
1. Go to Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer)
2. Enter MOFU terms (for example, “seo,” “backlink,” “keyword”)
3. Go to the **Matching terms** report
4. In the “Include” filter, add terms like “tool,” “tools,” “checker,” “calculator”
...
>
> — Nat Eliason (@nateliason) [December 6, 2020](https://twitter.com/nateliason/status/1335697034205147142?ref_src=twsrc%5Etfw)

Email is the highest value “interest indication.” It’s explicit permission from someone to enter their inbox.

You’ll want to make sure your website visitors are signing up for your email list. Use landing pages or calls to action to encourage them to subscribe. For example, we have a floating sign-up box beside every blog post for our [newsletter](https://ahrefs.com/newsletter):
...
For many companies, signing up here turns them into “marketing-qualified leads”.
...
According to [PowerReviews’ 2023 survey](https://www.powerreviews.com/research/power-of-reviews-2023/):
...
However, even highly satisfied customers may not remember to leave reviews, so you’ll want to ask for one when the opportunity arises. For example, a high customer satisfaction moment is when they’ve used your product or service (e.g., Airbnb asks for reviews when you’ve finished your stay).

Finally, whether good or bad, you’ll want to respond to these reviews. A [Harvard Business Review study](https://hbr.org/2018/02/study-replying-to-customer-reviews-results-in-better-ratings) found that replying to reviews results in better overall ratings.

My colleague, [Andrei Țiț](https://twitter.com/AndrezMarcel), replies to all our reviews:
...
>
> Use content marketing to guide people into visualizing how to use your product in their daily and work lives. If they see your product in action, they can imagine themselves using it.
>
>
>
> Tim Soulo, CMO [Ahrefs](https://ahrefs.com)

For example, our [YouTube videos](https://youtube.com/@AhrefsCom) and articles feature our toolset prominently. We even have [multiple free, full-length courses](https://ahrefs.com/academy) that show you how to solve SEO problems with our toolset:
...
- [**Ahrefs Webmaster Tools**](https://ahrefs.com/webmaster-tools) – Free access to [Site Explorer](https://ahrefs.com/site-explorer) and [Site Audit](https://ahrefs.com/site-audit).
- [**Free SEO tools**](https://ahrefs.com/free-seo-tools) – Various free tools that’ll help you with keyword research, link building, and more.
...
1. Convince potential customers to choose you.
2. Get them to buy now.
...
1. Go to Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer)
2. Enter your brand and/or your competitors’ brands
3. Go to the **Matching terms** report
4. In the “Include” filter, add words like “vs, versus, review, reviews”
...
So if your cohort-based course is closing or a product is going [out of stock](https://ahrefs.com/blog/ecommerce-out-of-stock-products/) soon, give potential customers a heads-up.
...
You can track most of these metrics via tools like [Google Analytics](https://ahrefs.com/seo/glossary/google-analytics), [Google Search Console](https://ahrefs.com/blog/google-search-console/), and [Ahrefs](https://ahrefs.com/).

Further reading

- [25 Marketing Metrics You Should Consider Tracking](https://ahrefs.com/blog/marketing-metrics/)
- [The Only 3 Google Analytics Metrics You Need to Track](https://ahrefs.com/blog/google-analytics-metrics/)
...
Some marketers have found the existing model to be incomplete because it focuses solely on converting a prospect into a customer. After all, conventional marketing wisdom states that it’s cheaper to retain existing customers than to acquire new ones.
...
- **Loyalty stage** – At Ahrefs, we have a [customers-only community](https://community.ahrefs.com/) where our loyal customers can hang out, ask questions, and provide feedback on our toolset.
- **Advocacy** **stage** – Consider setting up referral or loyalty programs so it’s easier for your customers to refer your product to their friends. You could also consider inviting some of them to be brand advocates.

## Final thoughts

The funnel provides a model for you to analyze and improve your marketing.

Tweaking it is a never-ending process. But that’s the fun part of funnel marketing. Keep on experimenting, and you’ll find ways to improve your results.

Any questions or comments? Let me know [on Twitter](https://twitter.com/siquanong) or [Threads](https://www.threads.net/@siquanong).
