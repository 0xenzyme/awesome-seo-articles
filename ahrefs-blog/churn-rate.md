...
canonical: "https://ahrefs.com/blog/churn-rate/"
author: "Michal Pecánek"
published: "2022-02-25T07:00:06+00:00"
updated: null
categories:
  - "General Marketing"
freshness_reasons:
  - "date_2022_old"
  - "missing_updated"
fetched_at: "2026-06-12T11:22:03+00:00"
status_code: 200
html_hash: "a2bf9ca07b42ba0c1f1942ecfb9dff94ab4b8e56746962c62f90a96646158b12"
clean_word_count: 3695
clean_char_count: 22257
---
...
- [What makes churn rate so important](#1-what-makes-churn-rate-important)
- [How to calculate churn rate](#2-how-to-calculate-churn-rate)
- [What’s a good churn rate for your business](#3-what%E2%80%99s-good-churn-rate)
- [Nine ways to decrease churn rate](#4-nine-ways-decrease-churn-rate)
...
| --- | --- | --- | --- | --- | --- | --- |
| 25% growth  5% churn | $1,000,000 | $1,200,000 | $1,440,000 | $1,728,000 | $2,073,600 | $2,448,320 |
| 25% growth  10% churn | $1,000,000 | $1,150,000 | $1,322,500 | $1,520,875 | $1,749,006 | $2,011,357 |
...
[Word-of-mouth marketing (WoMM)](https://ahrefs.com/blog/word-of-mouth-marketing/) is the process of influencing and encouraging natural discussions about a product, service, or company. I’m sure you’ve subscribed to some product or service because someone you trust told you about it. For this reason, WoMM can be one of the most powerful marketing channels.

The fact that more than 14,000 new customers in 2020 told us they were referred to [Ahrefs](https://ahrefs.com/) by their friends is the best proof of WoMM’s importance:
...
LTV is yet another important metric, even a [marketing KPI](https://ahrefs.com/blog/marketing-kpis/), that you should keep track of. The best way for subscription-based companies to calculate the metric is as follows:
...
But we need a number. It’s important to have an anchor to recognize instances when churn is a minor problem and we should, thus, prioritize achieving other [marketing objectives](https://ahrefs.com/blog/marketing-objectives/). Fortunately, all we need here is to get more specific with Google queries.
...
There seems to be a misconception that churn happens after someone becomes your customer. No. You can influence your churn rate in all stages of the [marketing funnel](https://ahrefs.com/blog/marketing-funnels/):

Let’s show you how.

### 1. Collect feedback from churned customers

Talking to your customers is an important part of [market research](https://ahrefs.com/blog/market-research/). But you may learn even more when you talk to people and companies that stopped paying for your product or service.

Now don’t fall into the trap of taking action on everything you hear from those who churned. Just systematically collect the feedback to get a solid sample. Then decide if taking action on their objections and problems makes sense for your product roadmap and [marketing strategy](https://ahrefs.com/blog/marketing-strategy/).
...
Let’s give the theory a more actionable spin. Your marketing communication should consistently convey what your product does and how a potential customer can benefit from that. For example, here’s a humble brag about [our homepage](https://ahrefs.com/) that does the job of providing clear communication well:
...
Again, we’re back at [market research](https://ahrefs.com/blog/market-research/) that should tell you about the preferences of each of your market segments and what’s important for them. Adjust your positioning and communication based on this.

### 3. Make sure you target the right audience

Some customer segments churn more than others. You saw the brutal contrast between Cloudflare (with 36% churn) and Fastly (with 0.7% churn). In an ideal world, you’d be spending most of your resources on reaching audiences that allow for [product-market fit](https://ahrefs.com/blog/product-market-fit/).
...
An important takeaway here is you can make people try your product way before they’re ready to sign up. Our [keyword generator](https://ahrefs.com/keyword-generator), for example, is one of [many free SEO tools we offer](https://ahrefs.com/free-seo-tools):
...
A similar use case is our free [Ahrefs Webmaster Tools](https://ahrefs.com/webmaster-tools). It provides SEO data, insights, and recommendations that are useful and actionable even for beginners. After a few weeks or months of using these products, the beginner may consider stepping up their SEO game and signing up for the full version.
...
We have an [extensive academy of video courses](https://ahrefs.com/academy) going through every nook and cranny of the toolset, showing you how to crush SEO:
...
Screenshot taken from Ahrefs’ [Content Explorer](https://ahrefs.com/content-explorer).
...
https://twitter.com/jsvxc/status/1457769184700502025
...
We can afford this claim since we produce [product-led content](https://ahrefs.com/blog/) and educate our readers on how Ahrefs can help them solve hundreds of SEO and marketing problems.

[Use every channel](https://ahrefs.com/blog/marketing-channels/) possible to distribute your product education resources. Here’s a list of all the channels we own and use for product education (feel free to take inspiration from them):

1. Newsletter
2. Ahrefs social media accounts + our personal accounts
3. [Ahrefs FB Insider group](https://www.facebook.com/groups/ahrefsinsider)
4. [Ahrefs blog](https://ahrefs.com/blog/)
5. [Ahrefs YouTube channel](https://www.youtube.com/channel/UCWquNQV8Y0_defMKnGKrFOQ)
6. [Ahrefs Academy](https://ahrefs.com/academy)
...
1. Collect and evaluate customer feedback ([we do this partially in public](https://ahrefs.canny.io/))
...
Most types of software that manage these surveys for you will also calculate the NPS. Generally speaking, an NPS score above 70 is considered exceptionally good. But always [check benchmarks for your industry](https://www.retently.com/blog/good-net-promoter-score/), as they may be much lower.
...
Here’s wishing you lower churns and higher growth! If you’ve got any questions, ping me [on Twitter](https://twitter.com/michalpecanek).
