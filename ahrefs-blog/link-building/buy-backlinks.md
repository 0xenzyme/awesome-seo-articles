---
title: "Should You Buy Backlinks in 2024? It Depends"
source: ahrefs-blog
content_type: "blog_article"
freshness_risk: "medium"
slug: "buy-backlinks"
url: "https://ahrefs.com/blog/buy-backlinks/"
canonical: "https://ahrefs.com/blog/buy-backlinks/"
author: "Joshua Hardwick"
published: "2022-11-18T06:00:00+00:00"
updated: "2024-07-18T16:03:47+00:00"
categories:
  - "Link Building"
freshness_reasons:
  - "date_2024_watch"
  - "title_year_2024_before_2026"
fetched_at: "2026-06-12T11:20:37+00:00"
status_code: 200
html_hash: "19a144d5c00a3bd125f1d5a0dc00ce95c811f3ff04a5ef3afb265b9784266311"
clean_word_count: 2230
clean_char_count: 12758
---
# Should You Buy Backlinks in 2024? It Depends

Buying backlinks in short

- Buying backlinks to help rankings violates [Google’s spam policies](https://developers.google.com/search/docs/essentials/spam-policies).
- Google may rank your site lower in results or not at all if it detects paid links.
- Most link builders are happy to take the risk, with [74.3% buying backlinks](https://www.authorityhacker.com/link-building-survey/).
- Paid links cost $83 on average—but they can often cost much more.
- Due to how risky it is, **our advice is not to buy backlinks**. ([Here’s how to build or earn links safely](#how-to-build-links).)

## Risks of buying backlinks

Paid backlinks carry two risks. One is more severe than the other, but neither are good.

### Risk 1. Google will ignore your paid links, making them a waste of money

Since the [Penguin 4.0 update](https://ahrefs.com/google-algorithm-updates) in 2016, Google’s algorithms are now able to ignore many spammy and paid backlinks. This means they won’t help or hurt rankings, so buying them is money down the drain.

### Risk 2. Google will penalize and demote your website’s rankings

Google has an army of human reviewers who can impose manual actions on websites. If you get one of these, some or all of your site will not be shown in Google’s search results.

Sidenote.

You’ll know if you have a manual action, as it’ll show up in the [Manual Actions report](https://support.google.com/webmasters/answer/9044175?hl=en) in Google Search Console.

## Why people still buy backlinks

There are likely many different reasons, but in my opinion, it largely comes down to these two:

### Reason 1. Buying links is *much* easier than building or earning them

Many site owners will ask for money to place a link—even if you have [great content](https://ahrefs.com/blog/how-to-write-great-content/).

This is the unfortunate state of SEO in 2024. People are justifiably tired of receiving link outreach emails and know that many SEOs have the budget to pay them for links. Why give links for free when someone is willing to pay?

### Reason 2. Paid links can help rankings… if Google doesn’t detect them

Paid links often look no different to earned links, so it’s quite possible to “trick” Google and get higher rankings with paid backlinks.

For example, here’s a page about the best online casinos that’s thriving in organic search:

If we take a look at its backlink profile in Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer), it seems extremely likely to me that many of these links were paid for:

Neither of those anchors look natural or legit.

As time goes by, Google gets better and better at spotting and demoting paid backlinks—but it’s never going to be perfect. They can still move the needle.

Sidenote.

It’s entirely possible that the (likely) paid backlinks in the screenshot above are already being ignored by Google. The page’s rankings may be due to earned backlinks or other factors entirely, such as the content itself.

## How much do paid links cost?

Paid links cost $83 on average according to [Authority Hacker’s survey](https://www.authorityhacker.com/link-building-survey/) of 755 link builders.

Can they be had for less? Yes. Head over to Fiverr and you’ll find packages with thousands of backlinks for just a few dollars.
...
2. **Paid/sponsored guest posts** – You write an article that contains links to your site, then pay a site owner to publish it on their website.
3. **Private blog networks (PBN**s**)** — You build a network of sites yourself, then link to your “money” site from all of them. (This is becoming a bit less common these days, but people still do it).

A few years ago, I ran a small study to investigate the costs of the first two [types of links](https://ahrefs.com/blog/types-of-backlinks/).

### How much do paid niche edits cost?
...
Links help you rank higher, and ranking high for competitive terms can earn you a *lot* of money.
...
My guess: This website is part of a [private blog network](https://ahrefs.com/seo/glossary/private-blog-network) or set up for the sole purpose of selling backlinks.
...
To check this, plug the domain into Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer) and go to the **Overview** report.
...
If traffic has recently fallen off a cliff or seems to fluctuate dramatically, it may have been hit by a Google update. For that reason, it’s worth scrolling to the “Performance” graph on the **Overview** report in [Site Explorer](https://ahrefs.com/site-explorer) to see the site’s organic traffic over time.
...
If we hit the toggle to overlay [Google updates](https://ahrefs.com/google-algorithm-updates) on the graph, we see that the traffic drop coincided with the Core Update in August 2018.
...
### 3. Has the site been selling links? (AKA is it a “link farm”?)
...
An often faster way to do this is to check the **Outgoing Link Anchors** report in Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer) for followed external links with odd anchors.
...
To check, use the **Anchors** report in Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer) to look for followed links with unnatural anchors to its homepage.
...
In this case, I’d say the link looks suspiciously like a paid one because of the exact-match [anchor text](https://ahrefs.com/blog/anchor-text/).
...
Buying links is very risky, so **it’s not something I’d recommend**.

This is especially true for legitimate business owners whose livelihoods rely on their Google rankings.

However, if you fully understand and accept the high risks of buying backlinks, there’s no reason why you can’t. Does it arguably make the web a worse place? Definitely. Is it illegal? Not at all.

Got questions? Ping me [on X](https://twitter.com/joshuachardwick?lang=en).
