...
canonical: "https://ahrefs.com/blog/google-sandbox/"
author: "Nick Churick"
published: "2018-07-05T08:22:33+00:00"
updated: "2022-10-31T08:46:55+00:00"
categories:
  - "General SEO"
freshness_reasons:
  - "date_2022_old"
fetched_at: "2026-06-12T11:34:20+00:00"
status_code: 200
html_hash: "5931b188bf21cc748aaa1265697a9a748e7599b21f6b58780fc4021d01a1fac2"
clean_word_count: 2908
clean_char_count: 17804
---
...
- **[Bill Sebald](https://twitter.com/billsebald)**, the owner of [Greenlane](https://www.greenlanemarketing.com) digital marketing agency
- **[Edward Sturm](https://twitter.com/Edward_Sturm)**, Director of Marketing @ [World of Ether](https://worldofether.com), previously SEO specialist at iProspect
- **[Eric Sachs](https://twitter.com/EricSachs_SEO)**, SEO expert and CEO of [Sachs Marketing Group](https://sachsmarketinggroup.com)
- **[Andy Crestodina](https://twitter.com/crestodina)**, co-founder of [Orbit Media](https://www.orbitmedia.com/) (Andy was especially excited about this topic. He has worked on 1000+ website projects over 18 years and had a lot to share).
...
Rand Fishkin, for example, believed that [SEOmoz had been sandboxed for 9 months](https://moz.com/blog/seomoz-escapes-the-sandbox), despite its perfectly natural strong backlink profile.
...
>
>
> Rand Fishkin, Co-founder [Moz](https://moz.com)

There was even a theory that the Google sandbox was [pushing people to spend money on PPC](https://moz.com/ugc/what-is-the-biggest-benefit-of-the-sandbox-effect-to-google).

In 2014 Google sandbox got another wave of interest when site owners and SEOs again saw that their new sites were not ranking as quickly as they used to, on a large scale. This was [mostly discussed on black hat forums](http://www.blackhatunderground.net/forum/the-advice-hub/google-waiting-period-aka-sandbox-for-new-sites) and could be the result of another anti-spam filter from Google.
...
A lot of SEO experts even list it among the [Google ranking factors](https://ahrefs.com/blog/google-ranking-factors/).
...
>
>
> Bill Sebald, Owner [Greenlane](https://www.greenlanemarketing.com/)
...
>
>
> Edward Sturm, Director of Marketing [World of Ether](https://worldofether.com/)
...
>
>
> Eric Sachs, CEO [Sachs Marketing Group](https://sachsmarketinggroup.com/)

> 1. The way search works, new domains have a big disadvantage. They just don’t have a [Domain Rating](/blog/ahrefs-seo-metrics/#section2) high enough to compete for much of anything. They may get indexed and rank for the brand, but that’s about it at first.
>
...
> - **Ranking for ultra-low competition,** **[long tail phrases](https://ahrefs.com/blog/long-tail-keywords/)***: Especially if they are the titles and headers for a nice detailed page, this should start working within a month*
...
>
>
> Andy Crestodina, Co-founder [Orbit Media](https://www.orbitmedia.com/)
...
In addition, many SEOs strongly believe that Google considers user behaviour in their ranking algorithms via [click-through rates](https://ahrefs.com/blog/how-to-improve-ctr/), [dwell time](https://ahrefs.com/seo/glossary/dwell-time), and other metrics, which they can potentially collect and analyze.
...
![](https://ahrefs.com/blog/wp-content/uploads/2018/07/possible-honeymoon-period.png)

Organic traffic graph from [Site Explorer](https://ahrefs.com/site-explorer) for our recent post about [keyword research tools](https://ahrefs.com/blog/free-keyword-research-tools/).
...
> we don’t have a “sandbox”. Don’t worry about it [@JohnMu](https://twitter.com/JohnMu?ref_src=twsrc%5Etfw)
>
> — Gary “鯨理” Illyes (@methode) [June 16, 2016](https://twitter.com/methode/status/743480243759964161?ref_src=twsrc%5Etfw)

> no
>
> — John ☆.o(≧▽≦)o.☆ (@JohnMu) [April 12, 2017](https://twitter.com/JohnMu/status/852131131889790976?ref_src=twsrc%5Etfw)

But let’s dig a bit deeper.

Here’s John Mueller’s answer to the question about the sandbox effect from a recent [Webmaster Hangout](https://www.youtube.com/watch?v=8m__-eaB_hU&feature=youtu.be&t=25m38s), streamed on Feb 23, 2018.
...
>
>
> John Mueller, Webmaster Trends Analyst at [Google](https://www.google.com)

Listen to the full answer [here](https://www.youtube.com/watch?v=8m__-eaB_hU&feature=youtu.be&t=25m38s), it is very insightful.

As for the importance of domain age for ranking, here is what Matt Cutts [said back in 2010](https://youtu.be/-pnpg00FWJY?t=82).
...
>
>
> Matt Cutts, Former Head of Webspam [Google](https://www.google.com)
...
As I already mentioned above, many SEOs are confident that CTR, [bounce rate](https://ahrefs.com/blog/bounce-rate/), and [dwell time](https://ahrefs.com/seo/glossary/dwell-time) are among the ranking factors. Until Google processes more behavioral data for your website and compares it with other sites, it might postpone ranking it for [popular keywords](https://ahrefs.com/blog/top-google-searches/).

### 3. Lack of quality backlinks

Backlinks (along with content and RankBrain) are one of the [top 3 ranking factors for Google](https://searchengineland.com/now-know-googles-top-three-search-ranking-factors-245882). If your content has a weak backlink profile and your website is not yet strong enough to pass “link juice” via internal links, why would Google rank it over other the sites with strong backlinks?

Our own [study of ranking factors](https://ahrefs.com/seo/on-page-seo) showed a strong correlation between the number of referring domains and rankings.

You can potentially build quite a few backlinks in just one month, but if they’re not [high-quality](https://ahrefs.com/blog/how-to-get-backlinks/), Google will just ignore them.

Suspicious rapidly grown backlink profiles and anchor text over-optimization [may get you a penalty](https://ahrefs.com/blog/google-penalties/).
...
> Can you avoid this “waiting period” with outstanding content and quality *[white-hat link-building](https://ahrefs.com/blog/white-hat-link-building-techniques/)?*

> In my experience, yes. Look at [Sparktoro.com](https://sparktoro.com/) as an example.
>
>
>
> Bill Sebald, Owner [Greenlane](https://www.greenlanemarketing.com/)
...
Here’s the screenshot from Ahrefs [Site Explorer](https://ahrefs.com/site-explorer) showing its backlink profile:

And here’s the number of organic keywords, and search traffic:

Looks really impressive!

But at a closer look, Sparktoro does not rank for any high-volume keywords in top 10 yet (excluding the brand keywords).

Organic Keywords report for sparktoro.com, via [Ahrefs Site Explorer](https://ahrefs.com/site-explorer)
...
> I don’t believe you can completely avoid it but I do believe you CAN expedite the process (see my [previous answer](#prev-answer) about the sandbox duration)
>
>
>
> Eric Sachs, CEO [Sachs Marketing Group](https://sachsmarketinggroup.com/)
...
>
> 1. Publish a set of articles on related blogs.
> 2. Interview a relevant influencer and make that the first post on your blog.
> 3. Ask friends with email marketing programs to add your site to the bottom of their emails that week in a “PS campaign”
> 4. Host an event and invite local influencers to come for short live social media videos.
> 5. Publish a new piece of original research on the new site, then reach out to podcasters to ask if they’d like to have you talk about it on their shows.
> 6. Create a pro bono donation for non-profits that starts accepting applications that day. Let the media know.
>
> The final set of tips on [our website launch checklist](https://www.orbitmedia.com/blog/website-launch-checklist/) includes a few other ideas. There are a million little ways to turn the birth of your new website into a little bit of news, attention, links and traffic.
>
>
>
> Andy Crestodina, Co-founder [Orbit Media](https://www.orbitmedia.com/)

Wrapping it up, just do all the quality [white-hat stuff](https://ahrefs.com/blog/white-hat-seo/) we’re advocating on our blog 😉
