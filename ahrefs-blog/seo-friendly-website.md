---
title: "How to Create an SEO-Friendly Website: The Complete Checklist"
source: ahrefs-blog
content_type: "blog_article"
freshness_risk: "low"
slug: "seo-friendly-website"
url: "https://ahrefs.com/blog/seo-friendly-website/"
canonical: "https://ahrefs.com/blog/seo-friendly-website/"
author: "Mateusz Makosiewicz"
published: "2022-06-10T07:37:45+00:00"
updated: "2024-06-16T21:43:53+00:00"
categories:
  - "General SEO"
freshness_reasons:
  - "date_2024_watch"
fetched_at: "2026-06-12T12:05:25+00:00"
status_code: 200
html_hash: "7148049f85a61d01d07b514af504aee38b8e17093d8e196d9591287fdd41b0bf"
clean_word_count: 3817
clean_char_count: 23802
---
...
- **Depth of the site structure** – Try not to have important pages too far away from the homepage (keeping at two or three clicks away is best and nothing further than six clicks). This is something big websites should especially watch out for, as overly nested pages can get [crawled](https://ahrefs.com/blog/crawl-budget/) less often.
...
**Recommended reading:** *[Website Structure: How to Build Your SEO Foundation](https://ahrefs.com/blog/website-structure/)*

#### 2. Set up Google Search Console

Google Search Console (GSC) is one of the three free tools that you can’t do SEO confidently without. It’s a free tool made for tracking your site’s organic search performance on Google’s search engine ([92.07% market share worldwide](https://gs.statcounter.com/search-engine-market-share)).
...
On top of that, GSC will also let you see the [keywords](https://ahrefs.com/blog/what-are-keywords/) you rank for (up to 1,000 in the tool itself) and check ranking positions.

You can get GSC [here](https://search.google.com/search-console/about).

**Recommended reading:** *[How to Use Google Search Console to Improve SEO (Beginner’s Guide)](https://ahrefs.com/blog/google-search-console/#how-to-set-up-google-search-console)*

#### 3. Set up Bing Webmaster Tools

Microsoft’s Bing Webmaster Tools is an equivalent of GSC that you should use to get data from Bing’s search engine ([the second-biggest search engine](https://gs.statcounter.com/search-engine-market-share)).

You can get Bing Webmaster Tools [here](https://www.bing.com/webmasters/help/getting-started-checklist-66a806de).

#### 4. Set up Ahrefs Webmaster Tools

[Ahrefs Webmaster Tools](https://ahrefs.com/webmaster-tools) (AWT) is our free tool that helps to improve a website’s SEO performance and get more organic search traffic.
...
Get it for free here: [Webmaster tools – Audit & Improve Your Website](https://ahrefs.com/webmaster-tools).

Sample email SEO health report from [AWT](https://ahrefs.com/webmaster-tools).

**Recommended viewing:** *[Ahrefs Webmaster Tools (AWT) – Our Free SEO Tool](https://www.youtube.com/watch?v=ipTk-qGrNlc)*
...
Make sure that a page doesn’t have those tags if you want it to rank. You can check that in the Coverage report inside GSC or the **Indexability** report in Ahrefs’ [Site Audit](https://ahrefs.com/site-audit) (part of [AWT](https://ahrefs.com/webmaster-tools)).
...
With [AWT](https://ahrefs.com/webmaster-tools) installed, go to the [Site Audit](https://ahrefs.com/site-audit) tool and open the **Page explorer** report. Inside the report, insert these four versions of your domain using the “Advanced” filter:
...
**Recommended reading:** *[301 Redirects for SEO: Everything You Need to Know](https://ahrefs.com/blog/301-redirects/)*
...
Google is using [mobile-first indexing](https://ahrefs.com/blog/mobile-first-indexing/). This means that it indexes and ranks content based on mobile versions of webpages. Consequently, having a website optimized for mobile devices is “strongly recommended,” as Google puts it in its [documentation](https://developers.google.com/search/mobile-sites/mobile-first-indexing).

You can check if your website is mobile-friendly in the eyes of Google using its [test tool](https://search.google.com/test/mobile-friendly) or use the Mobile Usability report in GSC.
...
Loading speed is a ranking factor and the fundament of [Core Web Vitals](https://ahrefs.com/blog/core-web-vitals/), which are performance metrics used for measuring user experience.

Rest assured—Google still promotes the most [relevant content](https://ahrefs.com/blog/relevant-content/) in its database. But when everything else is similar or equal, Google may rank the faster page higher.

You can monitor your website for speed issues with Ahrefs’ [Site Audit](https://ahrefs.com/site-audit). For this, use the **Performance** report.

**Recommended reading:** *[How to Improve Page Speed From Start to Finish (Advanced Guide)](https://ahrefs.com/blog/core-web-vitals/)*
...
This step is quite straightforward. You just need to get an SSL certificate and add it to your site (the easiest way is to get one from your hosting provider). You can even get one for free [here](https://letsencrypt.org/) (yes, Google recognizes it too).
...
The last on the list of [page experience signals](https://developers.google.com/search/docs/advanced/experience/page-experience). To Google, a page without intrusive pop-up windows is a usable site—and it’s hard to disagree with that.
...
**Recommended reading:** *[Interstitials and Dialogs | Google Search Central | Documentation](https://developers.google.com/search/docs/advanced/guidelines/avoid-intrusive-interstitials)*
...
- **Not too difficult to rank** – The quickest way to estimate this is to use a metric like our [Keyword Difficulty (KD)](https://ahrefs.com/blog/keyword-difficulty/). But you may also need to take other factors into consideration (see recommended reading below).
...
- [How to Choose the Right Keywords for SEO](https://ahrefs.com/blog/how-to-choose-keywords-for-seo/)
...
- Fresh.
- Unique.
- Aligned with [E-A-T guidelines](/blog/eeat-seo/).
...
You can increase your chances of earning or building links if you make your content link-worthy. That means including something so valuable and interesting that bloggers and journalists will want to link to it (aka [link bait](https://ahrefs.com/blog/link-bait/)).
...
- Ensure the description is not longer than 920 px (try [SERPSim)](https://www.highervisibility.com/seo/tools/serp-snippet-optimizer/).
...
There are different types of schema for different occasions: reviews, FAQs, person, place, organization, and many more. All of them will help Google show rich results on the SERPs (like the ones in the picture above) for your pages and potentially bring you more clicks. Here’s the full schema [documentation](https://schema.org/docs/schemas.html).

You can create and test your schema markup with tools like [schema.dev](https://schema.dev/).
...
**Recommended reading:** *[How to Create SEO-Friendly URLs (Step-by-Step)](https://ahrefs.com/blog/seo-friendly-urls/)*
...
According to [this video](https://www.youtube.com/watch?v=58zaiOx7TM4) from Google:
...
So including relevant outbound links is a best practice when [creating good content](https://ahrefs.com/blog/how-to-write-great-content/). But on top of that, citing your sources will help you to align your content with [E-A-T search quality guidelines](/blog/eeat-seo/), which are especially important for Your Money or Your Life topics (health, finance, safety, etc.).

**Recommended reading:** *[What Is EAT? Why It’s Important for SEO](/blog/eeat-seo/)*

#### 7. Optimize images

In short, optimizing images for SEO means you need to do three things:

- **Compress images** – You can use a plugin like [ShortPixel](https://wordpress.org/plugins/shortpixel-image-optimiser/) or a bulk image optimizer like [Kraken](https://kraken.io/web-interface).
...
- **Understand what a page is about** – Understanding the content of your pages helps Google rank them. The [anchor text](https://ahrefs.com/blog/anchor-text/) of the internal link matters too.

So make sure to interlink relevant content on your website and keep in mind that you can use links to boost other pages (aka the [Middleman Method](https://ahrefs.com/blog/orchard-seo-strategy/)).

The more content you have, the harder it is to keep up with internal linking. This is where [AWT](https://ahrefs.com/webmaster-tools) can do the heavy lifting for you. You can use the automatically generated report or use the “Advanced” filter to see link opportunities to a specific page.
...
- [Wix SEO vs. WordPress: 6.4M Domains Studied](https://ahrefs.com/blog/wix-seo/)
- [Squarespace SEO vs. WordPress: 3.6M Domains Studied](https://ahrefs.com/blog/squarespace-seo/)
- [10 Reasons Why WordPress Is the Best CMS for SEO](https://www.searchenginejournal.com/wordpress-best-cms-seo/)

Secondly, as mentioned in our checklist, make sure to set up [SEO audit tools](https://ahrefs.com/blog/free-seo-audit-tools/) for automatic SEO health monitoring (among others). As you add more content to your site, you may run into SEO issues like broken links, broken images, or [canonicalization issues](https://ahrefs.com/blog/canonicalization/). An audit tool will catch them for you.

One last piece of advice: If you have a JavaScript-heavy website, make sure to check out some additional steps covered in [this guide](https://ahrefs.com/blog/javascript-seo/#making-javascript-site-seo-friendly).
