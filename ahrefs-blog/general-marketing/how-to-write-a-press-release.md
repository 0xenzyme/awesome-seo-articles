...
url: "https://ahrefs.com/blog/how-to-write-a-press-release/"
canonical: "https://ahrefs.com/blog/how-to-write-a-press-release/"
author: "Rebecca Liew"
published: "2022-01-12T01:07:51+00:00"
updated: "2024-12-27T10:55:36+00:00"
categories:
  - "General Marketing"
freshness_reasons:
  - "date_2024_watch"
fetched_at: "2026-06-12T11:40:29+00:00"
status_code: 200
html_hash: "cd968724518b45f85b8f38b1faef9d966db3bb91e48740893fe481baf0a77092"
clean_word_count: 3208
clean_char_count: 19827
---
...
- [What a press release is](#1-what-is-a-press-release)
- [When to use a press release](#2-when-to-use-press-release)
- [How to distribute a press release](#3-how-distributed)
- [What to avoid in a press release](#4-what-to-avoid-in-press-release)
- [How to craft a press release](#5-how-to-craft-press-release)
- [Tracking a press release’s performance](#6-track-press-release-performance)

Press release template

Do note our template is only a guide. Be sure to consult the style guide your company uses and tweak the template accordingly. [Get the template here](https://docs.google.com/document/d/1RVhoR0MNYfSSnBsCFLVc2TG3xypHybKF67-d3m4S2eI/copy).
...
Our CMO, Tim Soulo, can vouch for this, having manually sent out over 100 personalized outreach emails [as part of a link outreach experiment.](https://ahrefs.com/blog/email-outreach/)

At the risk of sounding stalkerish, it’s also possible to [find anyone’s email address](https://ahrefs.com/blog/find-email-address/) today.
...
[PR Newswire](https://www.prnewswire.com/) is one widely used option. It can be used to schedule or disseminate news to thousands of news agencies, media publishers, editors, and journalists instantly.
...
The [subtle sell](https://www.investopedia.com/terms/s/soft-sell.asp#:~:text=Soft%20sell%20refers%20to%20an,customers%20and%20pushing%20them%20away.) can be tricky to achieve, but you’ll be in good stead once you find this balance.
...
Choosing quotes is tricky business. As The Guardian [puts it](https://www.theguardian.com/small-business-network/2014/jul/14/how-to-write-press-release), your quotes should offer insight, not information.
...
[Here’s one](https://www.apple.com/newsroom/2021/10/introducing-the-next-generation-of-airpods/) that checks all the boxes on this front:
...
The Associated Press (AP) is one of the world’s largest news agencies, and [its stylebook](https://www.apstylebook.com/) is used as a reference point by journalists globally. It ensures consistency in your press release content.
...
- **Brand mentions**Apple mentions itself in the third person in all of its press releases, [including this one](https://www.apple.com/newsroom/2021/10/introducing-the-next-generation-of-airpods/). So instead of saying, “We have launched the third generation of AirPods,” the company phrases itself like so:

- **In quotes**Another thing to note is, ideally, any featured persons should be quoted in the past tense—so *said*, *shared, noted,* etc*.*

### 2. Choose your format

The structure of a press release doesn’t deviate all that much, as you’ll see from our [downloadable template](https://docs.google.com/document/d/1RVhoR0MNYfSSnBsCFLVc2TG3xypHybKF67-d3m4S2eI/copy).
...
[Here’s](https://www.apple.com/newsroom/2021/10/introducing-the-next-generation-of-airpods/) an example of a multimedia press release featuring Apple’s new AirPods. In addition to hyperlinked text, there are downloadable images located throughout.
...
The most important information should be at the very beginning of your release. To identify what those key facts are, use the [inverted pyramid](https://ahrefs.com/blog/seo-copywriting/#inverted-pyramid-method):

Think of this in terms of how news articles are structured.

The headline features the most important, eye-catching information of your press release, and the opening paragraph of the release should answer [the five Ws and one H](https://newsmoor.com/news-writing-process-how-to-write-a-news-5w-and-1h-of-report-writing-in-journalism/) (who, what, when, where, why, how).
...
Let’s return to our earlier example of [this Apple press release](https://www.apple.com/newsroom/2021/10/introducing-the-next-generation-of-airpods/).
...
Adding images (along with image descriptions and/or captions) is optional. But research has shown that a press release with images is [seven times more likely](https://www.5wpr.com/new/press-release/) to be read than skimmed.
...
Remember to include a link to downloadable assets (try using a URL shortener tool like [bit.ly](https://bit.ly/)) at the bottom of your press release.
...
**Name (bolded)**Name of company or PR agency
Email address
...
Most distribution services offer basic visibility reports that allow you to review commonly tracked metrics, such as click-through rates, conversion rates, [backlinks](https://ahrefs.com/blog/what-are-backlinks/), and downloads (if you released the press release in pdf form).

The trouble is such services can be expensive, so a free tool like [Ahrefs Webmaster Tools](https://ahrefs.com/webmaster-tools) can help to offset unnecessary costs while allowing you to easily track backlinks and mentions.

### How to track backlinks

First, [follow this pictorial guide](https://help.ahrefs.com/en/articles/4455322-setting-up-your-first-project-in-ahrefs-webmaster-tools-awt) to set up your first project on [Ahrefs Webmaster Tools](https://ahrefs.com/webmaster-tools).

Then, in Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer), enter the URL of the page on which your press release is hosted. From here, you’ll be able to see the number of backlinks received.

For a detailed breakdown, head to the panel on the left and go to *Backlink profile > Backlinks***.** Here, you can look at “live” backlinks, as well as [recent and historical ones](https://help.ahrefs.com/en/articles/1293367-what-are-live-recent-and-historical-links).

You can also hover over the tooltip (marked with a tiny “i”) on each metric to get a better idea of what you’re looking at.

If you’re in a hurry or aren’t sure if it’s worth signing up for a free account, try using our [free backlink checker tool](https://ahrefs.com/backlink-checker) instead. The tool provides an overview of the top 100 backlinks for your page.

### How to track mentions

If you’re interested in monitoring the mentions of certain keywords, quotes, or your brand’s latest products, you can set these up in [Ahrefs Alerts](https://ahrefs.com/alerts). These mentions will be sent to your email inbox at a frequency of your choosing.

[Here’s a step-by-step guide](https://help.ahrefs.com/en/articles/2349079-how-to-set-up-new-mentions-in-ahrefs-alerts#) on how to do it.

While it may seem similar to [Google Alerts](https://www.google.com.sg/alerts), [Ahrefs Alerts](https://ahrefs.com/alerts) offers a more comprehensive view of insights, according to our [mini study](https://ahrefs.com/blog/how-to-set-up-google-alerts/) of both monitoring tools.
...
Got something to say? Ping me [on Twitter](https://twitter.com/RebLiew) with your thoughts and suggestions.
