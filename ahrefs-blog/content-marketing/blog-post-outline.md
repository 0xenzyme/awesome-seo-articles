---
title: "How to Write a Blog Post Outline (7 Simple Steps)"
source: ahrefs-blog
content_type: "blog_article"
freshness_risk: "low"
slug: "blog-post-outline"
url: "https://ahrefs.com/blog/blog-post-outline/"
canonical: "https://ahrefs.com/blog/blog-post-outline/"
author: "Si Quan Ong"
published: "2022-09-23T06:00:00+00:00"
updated: "2023-09-27T20:18:34+00:00"
categories:
  - "Content Marketing"
freshness_reasons:
  - "date_2023_aging"
fetched_at: "2026-06-12T11:19:08+00:00"
status_code: 200
html_hash: "4880c4e2d1a8823f3dd945d30475237e7aea5185e7c3cae43018c5a4695ad873"
clean_word_count: 1805
clean_char_count: 10370
---
...
Otherwise, a good way to find topics is to use Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer). Enter a relevant term into the tool and go to the **Matching terms** report.

Switch the tab to **Questions,** and you’ll see plenty of potential topics to cover.

## 2. Select your content format

Will your article be a [listicle](https://ahrefs.com/blog/listicle/) or a how-to? Or perhaps it’s an opinion piece, a review, or you’re simply covering the latest news.

Whatever it is, you’ll have to decide on a format.

Sometimes, the format is screaming at you in plain sight. For example, if you’re covering the topic “**how to** make kefir at home,” then it’s probably going to be a **how-to guide.** Or if you’re covering the topic “[blogging tips](https://ahrefs.com/blog/blogging-tips/),” then it’s probably going to be a **list** of tips.
...
**Recommended reading:** [*10 Types of Blog Posts & How to Use Them Effectively*](https://ahrefs.com/blog/types-of-blog-posts/)
...
- **Can you crowdsource opinions and ideas?** For example, you can poll members in [r/ramen](https://www.reddit.com/r/ramen/) for their best at-home ramen recipes.
- **Can you provide data or back your article with science?** For example, you can potentially show readers how to create the “perfect” ramen by [looking at the sensory relationship](https://pubmed.ncbi.nlm.nih.gov/18034748/) between different acids and flavors.
...
You can also look at the top-ranking pages on Google to get inspiration on what angle you should cover. For example, if we search for “date ideas” on Google, we see angles like:
...
**Recommended reading:** [*4 Simple Blog Post Templates (And When to Use Them)*](https://ahrefs.com/blog/blog-post-templates/)
...
- Paste a few top-ranking URLs for your main topic into Ahrefs’ [Content Gap tool](https://ahrefs.com/content-gap)
...
These are known as [People Also Ask (PAA) boxes](https://ahrefs.com/blog/people-also-ask/), and they answer questions related to your search query. Since these are likely popular questions, you may want to answer them in your content too.

To gather all of these questions, you can either click on them over and over or use a tool like [AlsoAsked](https://alsoasked.com/).
...
For example, here’s a recent outline of mine for a [post on content pillars](https://ahrefs.com/blog/content-pillars/):
...
We do this all the time. Every in-house writer has to send their outlines to [Josh](https://twitter.com/JoshuaCHardwick), our head of content, for review.
...
If you need help writing a blog post, check out this [step-by-step guide on how to write one](https://ahrefs.com/blog/how-to-write-a-blog-post/).
