---
title: "23 Beginner Blogging Tips to Get Better at Blogging (Fast)"
source: ahrefs-blog
content_type: "blog_article"
freshness_risk: "low"
slug: "blogging-tips"
url: "https://ahrefs.com/blog/blogging-tips/"
canonical: "https://ahrefs.com/blog/blogging-tips/"
author: "Si Quan Ong"
published: "2023-09-27T08:34:49+00:00"
updated: "2025-06-23T16:17:55+00:00"
categories:
  - "Content Marketing"
  - "General SEO"
freshness_reasons: []
fetched_at: "2026-06-12T11:19:32+00:00"
status_code: 200
html_hash: "441d27467ef81549cd01c928868c53293e4c27c10671a0dcf6ebbee3590ca650"
clean_word_count: 3548
clean_char_count: 21661
---
...
[53.3% of all website traffic](https://ahrefs.com/blog/seo-statistics/) comes from organic results in search engines like Google. That makes [ranking high on Google](https://ahrefs.com/blog/how-to-rank-higher-on-google/) for topics that people *regularly* search for a proven way to get consistent traffic.

The process of finding these blog post ideas is called keyword research.

Here’s how to do it:

1. 1. Go to a keyword research tool like [Keywords Explorer](https://ahrefs.com/keywords-explorer)

1. 1. Enter a niche-relevant keyword

1. 1. Go to the Matching terms report

1. 1. Switch the tab to Questions to find blog post ideas

1. 1. Choose topics based on traffic potential (estimated potential traffic if you were to rank #1)
...
1. 1. Go to [Site Explorer](https://ahrefs.com/site-explorer)

1. 1. Enter your competitor’s domain
...
You can use nearly any [project management](https://ahrefs.com/blog/seo-project-management/) tool (free and paid) to create a content calendar in minutes. Here are a few tools I’ve tried:
...
1. 1. People search in social media for brands. If you’re not there, no one will find you.

1. 1. You don’t necessarily need a following to get traffic from social media. For example, many people use search to discover new content on Pinterest. The same holds true for TikTok and Instagram.
...
We send a weekly blog newsletter to our subscribers.
...
1. 1. Sign up for a free account with an email marketing service provider like ConvertKit or Mailchimp.

1. 1. Add an opt-in form on your website.
...
1. 1. Search for quora.com in Site Explorer

1. 1. Go to the organic keywords report

1. 1. Search for a keyword related to your niche

1. 1. Hit the caret to see the estimated search traffic to a page
...
Website monitoring tools like [Ahrefs’ Web Analytics](https://ahrefs.com/web-analytics), [Google Search Console](https://search.google.com/search-console/about), and [Ahrefs Webmaster Tools](https://ahrefs.com/webmaster-tools) provide intelligence on your blog visitors. All of these tools are free to use.
...
1. 1. Go to [Content Explorer](https://ahrefs.com/content-explorer)

1. 1. Enter the topic of your content

1. 1. Go to the **Authors** tab
...
1. 1. Sign up for the free [Ahrefs Webmaster Tools (AWT)](https://ahrefs.com/webmaster-tools)

1. 1. Run a crawl using [Site Audit](https://ahrefs.com/site-audit)

1. 1. When the crawl is done, go to the **Internal link opportunities** report
