---
title: "14 Cheap & Effective Small-Business Marketing Strategies"
source: ahrefs-blog
content_type: "blog_article"
freshness_risk: "medium"
slug: "small-business-marketing-strategies"
url: "https://ahrefs.com/blog/small-business-marketing-strategies/"
canonical: "https://ahrefs.com/blog/small-business-marketing-strategies/"
author: "Mateusz Makosiewicz"
published: "2022-08-30T05:30:00+00:00"
updated: "2022-10-19T04:21:29+00:00"
categories:
  - "General Marketing"
freshness_reasons:
  - "date_2022_old"
fetched_at: "2026-06-12T12:10:23+00:00"
status_code: 200
html_hash: "646b4b50ac72e1ea9a7f63b4ec14353cfe46ee5fbbb1696b0bb6da3ab25f56f7"
clean_word_count: 3648
clean_char_count: 22396
---
...
Reach for some basic [market research](https://ahrefs.com/blog/market-research/) tools:
...
**Recommended reading:** [*How to Achieve Product-Market Fit (5 Steps)*](https://ahrefs.com/blog/product-market-fit/)
...
Create or claim (option for already created GBPs) your Google Business Profile for free [here](https://www.google.com/business/).

And to make sure your profile is optimized, you can read our [guide on the topic](https://ahrefs.com/blog/google-my-business/).
...
- Our [complete guide](https://ahrefs.com/blog/local-citations/) to building local citations.
- This [list of top local citations](https://whitespark.ca/top-local-citation-sources-by-country/) by country.

## 4. Manage your online reputation

According to a [study by BrightLocal](https://www.brightlocal.com/research/local-consumer-review-survey/), 91% of people regularly or occasionally read online reviews, and 84% trust online reviews as much as a personal recommendation.
...
Moreover, positive reviews [can impact rankings](https://ahrefs.com/seo/local-seo#local-seo-ranking-factors) in the Google Map Pack.
...
You can ask for reviews whenever you get a chance to contact your customers (personally, via email, via text message, in a thank-you note after purchase, etc.). But you can also use tools for generating reviews like [this one from Google](https://support.google.com/business/answer/7035772?hl=en).
...
You can answer that using a keyword tool. You can use our [free keyword generator](https://ahrefs.com/keyword-generator) to look up keywords that pop into your mind. You can even check their search demand in different countries and four different search engines.

Once you determine that SEO is worth it for you, use our detailed [step-by-step guide on creating SEO content](https://ahrefs.com/seo/seo-content).
...
If your business relies on direct contact or has a long sales cycle, you can ask for contact information in return for your free resource. This type of marketing tool is called a [lead magnet](https://ahrefs.com/blog/lead-magnet/).
...
Here’s how you can do it in Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer):
...
You can also find proven topics by analyzing your competitors and studying your niche. [See this guide for details](https://ahrefs.com/blog/lead-magnet/#3-how-to-find-topics-for-lead-magnets).

## 8. Start a video blog (with SEO in mind)

Video marketing is especially good for two things:

- **It helps to attract customers** – 70% of viewers bought from a brand after seeing it on YouTube ([Google](https://blog.google/products/ads/new-ways-to-drive-action/)).
- **It helps to educate your audience** – 96% of people have watched an explainer video to learn more about a product or service ([Wyzowl](https://www.wyzowl.com/video-marketing-statistics/)).
...
1. Go to Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer) and paste “youtube.com” as the URL
...
**Recommended viewing:** [*YouTube SEO: How to Rank YouTube Videos #1*](https://www.youtube.com/watch?v=Nh0mDbfEdVA)
...
- [**This guide**](https://ahrefs.com/blog/how-to-improve-seo/) – Go ahead and try everything from this guide, from improving the click-through rate of your top-performing content to going after featured snippets.
- **SEO tools** – Data on keywords and backlinks from your and your competitors’ sites can come from a tool like Ahrefs’ [Site Audit](https://ahrefs.com/site-audit). And data on your click-through rates from search engines will need to come from a tool specific to the search engine. For Google, this will be [Google Search Console](https://search.google.com/search-console/about). For Bing, it’s [Bing Webmaster Tools](https://www.bing.com/webmasters/about).
...
Sometimes, you can repurpose content that didn’t perform well in the past (but you have reasons to think it will work elsewhere). For example, you can take your unique, quality articles that just didn’t get enough [backlinks](https://ahrefs.com/blog/what-are-backlinks/) to challenge fierce competition on the SERPs and share them in a different format on social media platforms.
...
For the above techniques, follow our full guide on [content repurposing](https://ahrefs.com/blog/repurposing-content/).
...
Ahrefs’ [SEO Toolbar](https://ahrefs.com/seo-toolbar) allows you to see performance data of websites as you Google them. So the Google screenshot from above turns into this:
...
1. Go to [Site Explorer](https://ahrefs.com/site-explorer) and paste a URL you want to screen
...
- [Blogger Outreach: How to Do It at Scale (Without Feeling Like a Jerk)](https://ahrefs.com/blog/blogger-outreach/)
...
Use this [guide to write a press release](https://ahrefs.com/blog/how-to-write-a-press-release/) and send it to the magazines where the story is most relevant.
...
- Our free [website authority checker](https://ahrefs.com/website-authority-checker) will show you the Domain Rating (DR) for any given website. DR is a good proxy for checking the authority of the website and the possible SEO impact of links from it.
- [Ahrefs Webmaster Tools](https://ahrefs.com/webmaster-tools) will show all backlinks you got from PR efforts, among other features.

**Recommended reading:** [*Digital PR: The Beginner’s Guide to Making Your Brand Unmissable*](https://ahrefs.com/blog/digital-pr/)

## 13. Let others promote you through affiliate programs

Affiliate marketing programs allow [influencers](https://ahrefs.com/blog/influencer-marketing/), bloggers, and other kinds of online content creators to promote your products for a commission from sales.
...
At [loveandlemons.com](https://www.google.com/url?q=http://loveandlemons.com&sa=D&source=docs&ust=1661658508360995&usg=AOvVaw2QRe9U-3pmeEeqgWuzrbTF), of the biggest food blogs, you can shop for kitchen essentials and photography equipment. Makes sense because, at one point, the reader will surely wonder what gear its team uses for such great photos.
...
Depends on the [affiliate marketing program](https://ahrefs.com/blog/affiliate-marketing-programs/).
...
By using [competitor analysis tools](https://ahrefs.com/blog/competitor-analysis-tools/), you can learn things like:
...
So say you want to see which topics you haven’t blogged about yet compared to your competitors. You can check that quickly by pasting your and your competitors’ URLs in Ahrefs’ [Content Gap tool](https://ahrefs.com/content-gap).
...
**Recommended reading:** [*How to Conduct a Competitive Analysis (Template Included)*](/blog/competitive-analysis-guide/)
