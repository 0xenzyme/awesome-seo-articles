...
canonical: "https://ahrefs.com/blog/serp-volatility/"
author: "Louise Linehan"
published: "2024-08-19T10:28:26+00:00"
updated: "2025-03-03T10:35:41+00:00"
categories:
  - "General SEO"
freshness_reasons: []
fetched_at: "2026-06-12T12:09:33+00:00"
status_code: 200
html_hash: "b70806631c2d0de6f1e0663134bcf49770eb6a88e62b36af26be83be422e580b"
clean_word_count: 2985
clean_char_count: 18956
---
...
![A chart of visibility drops](https://ahrefs.com/blog/wp-content/uploads/2024/08/a-chart-of-visibility-drops-2.png)
...
[In the words of](https://www.searchenginejournal.com/hit-by-the-core-algorithm-5-factors-to-be-aware-of/515645/) Google’s Senior Search Analyst, [John Mueller](https://www.linkedin.com/in/johnmu/)
...
It’s clear from this example that individual SERPs are intrinsically volatile.

### What a “volatile” SERP looks like An example of a volatile SERP
...
## Why does SEO volatility happen?
...
As a Google spokesperson [told the BBC](https://www.bbc.com/future/article/20240524-how-googles-new-algorithm-will-shape-your-internet)
...
Take the latest August core update, for example. Google made algorithmic adjustments to promote useful content by small and independent publishers, and issued a notice to say that it would take [a full month to roll out](https://status.search.google.com/incidents/gVx6b2o78zke7GrMidGy).

Similarly, the [March 2024 core update](https://www.searchenginejournal.com/google-march-2024-core-update-officially-completed-a-week-ago/514919/) targeted hundreds of sites with manipulative content, and took 45 long days to complete.
...
I say “usually”, because Google also has a habit of pushing smaller updates live without warning – [like this one](https://www.seroundtable.com/google-deindexing-urls-february-2024-37382.html), where it deindexed a large number of URLs due to a “shift in perception” (in the words of Google Analyst, [Gary Illyes](https://ch.linkedin.com/in/garyillyes)).

Just like official updates, [unconfirmed updates](https://www.seroundtable.com/july-2023-google-webmaster-report-35647.html) can lead to wide scale fluctuation.
...
Sites ranking for freshness related keywords are more susceptible to movement because searchers are on the lookout for new information. Google refers to these keywords as “[Queries that deserve freshness](https://ahrefs.com/seo/glossary/query-deserves-freshness-qdf)”.

Examples of QDF keywords with volatile SERPs:

- News oriented keywords (e.g. [Paris Olympics](https://app.ahrefs.com/keywords-explorer/google/us/overview?keyword=paris%20olympics))
- Trending (e.g. [Willy Wonka experience](https://app.ahrefs.com/keywords-explorer/google/us/overview?keyword=willy%20wonka%20experience))
- Seasonal (e.g. [Pumpkin spice](https://app.ahrefs.com/keywords-explorer/google/us/overview?keyword=pumpkin%20spice))
...
Ever since the 2019 [diversity](https://ahrefs.com/google-algorithm-updates) update, Google has preferred to rank one site per SERP – [making exceptions](https://x.com/searchliaison/status/1136739064193998848) only for highly relevant content.
...
Thanks to some [leaked Google search documentation](https://sparktoro.com/blog/an-anonymous-source-shared-thousands-of-leaked-google-search-api-documents-with-me-everyone-in-seo-should-see-them/) shared by SparkToro’s [Rand Fishkin](https://www.linkedin.com/posts/randfishkin_look-im-not-saying-the-google-search-api-activity-7202223174665605120-CZdU/) and iPullRank’s [Mike King](https://www.linkedin.com/feed/update/urn:li:activity:7201042989148684289/), we can now say with quiet confidence that Google processes all of this user activity when it ranks content.
...
- Thin content
- Misinformation
- A lack of [E-E-A-T](https://ahrefs.com/blog/eeat-seo/)
- Slow load times
- Intrusive ads
- Keyword stuffing
...
[Search intent](https://ahrefs.com/blog/search-intent/) is the thread connecting everything you’ve read so far. When intent is changing or ambiguous, the SERPs become volatile.
...
Looking at the SERP comparison metrics, I noticed the top 10 positions had changed 17 times, and both pages had received a [SERP similarity](https://ahrefs.com/blog/whats-new-at-ahrefs-2022/) score of just 10/100.
...
To anticipate when the SERPs are about to shift, many SEOs monitor top-level SERP volatility using algorithm “weather” tools like [Algoroo](https://algoroo.com/).
...
In this example, I’m monitoring “Share of Voice” for a group of YMYL ( “[Your Money or Your Life](https://ahrefs.com/seo/glossary/ymyl-pages)”) sites.
...
You don’t have to just accept volatility. There are tons of things you can do to stabilize rankings – from improving your content’s [E-E-A-T](https://ahrefs.com/blog/eeat-seo/), to diversifying your traffic sources.

Garrett Sussman, Marketing Lead at iPullRank, gave a great bit of advice in the aftermath of the August 2024 update:

> “Remember the harsh reality if you see a ranking decrease: These updates are your grade for all of your past work and a syllabus for next year’s test. There’s rarely an immediate fix that can restore all of your traffic. The best thing you can do is assess where you lost traffic, analyze who won that traffic, and put together a plan to create better content that serves the search intent of your targeted keywords.”
>
>
>
> Garrett Sussman, Marketing Lead, [iPullRank](https://ipullrank.com/)

It’s beyond the scope of this article to go through every volatility prevention tactic, but I’ve included some of the most important ones below.
...
1. Create a “freshness portfolio” of your key content using [Ahrefs **Portfolios**](https://ahrefs.com/portfolios)
...
A simple [Google site operator](https://ahrefs.com/blog/google-advanced-search-operators/) search will help you find all existing pages on your site related to a topic.
...
When [Google’s Site Reputation Abuse update](https://www.seroundtable.com/google-enforcing-site-reputation-abuse-policy-37346.html) specifically targeted sites with manipulative link practices, SEOs would have had to run an audit to clean up their external link profiles and earn back visibility.

Diagnosing and fixing technical issues can improve your site’s ability to get indexed consistently in the SERPs. Chris Haines has written a great [11 step site audit guide](https://ahrefs.com/blog/seo-audit/) to get you started.
