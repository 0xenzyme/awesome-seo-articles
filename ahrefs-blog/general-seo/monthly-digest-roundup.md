---
title: "The Best of Ahrefs’ Digest: June 2024"
source: ahrefs-blog
content_type: "blog_article"
freshness_risk: "high"
slug: "monthly-digest-roundup"
url: "https://ahrefs.com/blog/monthly-digest-roundup/"
canonical: "https://ahrefs.com/blog/monthly-digest-roundup/"
author: "Si Quan Ong"
published: "2024-07-08T13:33:16+00:00"
updated: "2024-07-08T13:37:10+00:00"
categories:
  - "General SEO"
freshness_reasons:
  - "date_2024_watch"
...
fetched_at: "2026-06-12T11:50:52+00:00"
status_code: 200
html_hash: "2a25fed14af5070ff59dc5cca3e7233dc7114faf2d56ebbafcf870950952d336"
clean_word_count: 2397
clean_char_count: 14970
---
# The Best of Ahrefs’ Digest: June 2024

Every week, we share hot SEO news, interesting reads, and new posts in our newsletter, [Ahrefs’ Digest](https://ahrefs.com/newsletter).
...
**Author**: [Rand Fishkin](https://x.com/randfish)
...
1. Google appears to have ways to filter out clicks they don’t want to count in their ranking systems, and include ones they do. They also seem to measure the length of clicks.
2. Google uses Chrome to generate clickstream data.
3. Google uses whitelists for sensitive topics like travel, COVID, and politics
4. Scores and data generated by EWOK’s quality raters may be directly involved in Google’s search system, rather than simply a training set for experiments.
...
**Author**: [Mike King](https://x.com/iPullRank)
...
1. Yes, Google uses clicks
2. Yes, looks like there is a Google sandbox.

### [Google Documents Leaked & SEOs Are Making Some Wild Assumptions](https://ahrefs.com/blog/google-documents-leaked-seos-are-making-some-wild-assumptions/)

**Author**: [Patrick Stox](https://x.com/patrickstox)
...
### [How Recent Google Updates Punish Good SEO: 50-Site Case Study](https://zyppy.com/seo/google-updates-punish-good-seo/)

**Author**: [Cyrus Shepard](https://x.com/CyrusShepard)
...
1. Losing sites were far likelier to have more anchor text variations per page than winning sites.
2. Losing sites appeared to be updating their content more frequently (yes, more!) than winning sites
3. On average, losing sites used more structured data than winning sites.

### [On Writing Better: 43 Things I Learned from My Insane 2 Years of Study](https://blog.nateliason.com/p/on-writing-better)

**Author**: [Nat Eliason](https://x.com/nateliason)
...
### [HouseFresh Has Virtually Disappeared From Google Search Results. Now What?](https://housefresh.com/how-google-decimated-housefresh/)

**Author**: [Gisele Navarro](https://twitter.com/ichbinGisele), [Danny Ashton](https://twitter.com/dannyashton)

#### tl;dr

HouseFresh’s update to [their previous article](https://housefresh.com/david-vs-digital-goliaths/) on how Google is killing independent sites (featured in March).
...
### [The TIPI Framework](https://bryancasey.substack.com/p/the-tipi-framework)

**Author**: [Bryan Casey](https://x.com/bryanfcasey)
...
### [State of the SEO Job Market: Q1 2024](https://www.seojobs.com/community/seo-job-market/)

**Author**: [Nick LeRoy](https://x.com/NickLeRoy)
...
As Bryan Casey [writes](https://x.com/bryanfcasey/status/1791966308231168230), “Search can’t be separated from the web. It’s the operating system of the web.” Search will always exist, and therefore SEO will always exist. The form might change, and it’s up to all of us to adapt.

### [Heat Death of the Internet](https://www.takahe.org.nz/heat-death-of-the-internet/)

**Author**: [Takahē](https://x.com/takahemagazine)
...
### [Detailed Q3: Analysing The SEO Playbook of Digital Goliaths In-Depth, Every Quarter](https://detailed.com/q3/)

**Author**: [Glen Allsopp](https://twitter.com/ViperChill)
...
### [Why Ranch-Style SEO Is Your Future-Proof Content Strategy](https://www.clearscope.io/blog/ranch-style-seo-content-strategy)

**Author**: [Bernard Huang](https://twitter.com/bernardjhuang)
...
### [You Are Your Moat](https://sparktoro.com/blog/you-are-your-moat/)

**Author**: [Amanda Natividad](https://twitter.com/amandanat)
...
Morgan Housel calls this [“selfish writing”](https://collabfund.com/blog/selfish-writing/). YCombinator founder, Paul Graham wrote the same in his [post on useful writing](https://paulgraham.com/useful.html): “Use yourself as a proxy for the reader”.
...
**Author**: [Kevin Indig](https://twitter.com/Kevin_Indig)
...
### [How 16 Companies are Dominating the World’s Google Search Results](https://detailed.com/google-control/)
...
![The 16 companies getting 3.5 billion monthly clicks from Google across 588 brands](https://ahrefs.com/blog/wp-content/uploads/2024/04/the-16-companies-getting-3-5-billion-monthly-click.jpg)
...
This idea makes so much sense in terms of both UX and [E-E-A-T](https://ahrefs.com/blog/eeat-seo/). I’ve already pitched it to the team and we’re going to implement it on our blog.

### [How Google is Killing Independent Sites Like Ours](https://housefresh.com/david-vs-digital-goliaths/)

**Authors**: [Gisele Navarro](https://twitter.com/ichbinGisele), [Danny Ashton](https://twitter.com/dannyashton)
...
That said, I agree with most people that Forbes (with its dubious contributor model [contributing to scams and poor journalism](https://www.niemanlab.org/2022/02/an-incomplete-history-of-forbes-com-as-a-platform-for-scams-grift-and-bad-journalism/)) should not be rewarded so handsomely.

### [The Discussion Forums Dominating 10,000 Product Review Search Results](https://detailed.com/forum-serps/)
...
### [Who Sends Traffic on the Web and How Much? New Research from Datos & SparkToro](https://sparktoro.com/blog/who-sends-traffic-on-the-web-and-how-much-new-research-from-datos-sparktoro/)

**Author**: [Rand Fishkin](https://twitter.com/randfish)
...
But it would also be a mistake to look at this post and think Google is the **only** channel you should drive traffic from. As Rand’s [later blog post](https://sparktoro.com/blog/where-web-users-spend-time-vs-where-traffic-referrals-originate/) clarifies, “be careful not to ascribe attribution or credit to Google when other investments drove the real value.”
...
Each week, our team handpicks the best SEO and marketing content from around the web for [our newsletter](https://ahrefs.com/newsletter/). Sign up to get them directly in your inbox.
