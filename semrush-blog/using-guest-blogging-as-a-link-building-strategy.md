---
title: "The Definitive Guide to Using Guest Blogging as a Link Building Strategy"
source: semrush-blog
content_type: "blog_article"
freshness_risk: "medium"
slug: "using-guest-blogging-as-a-link-building-strategy"
url: "https://www.semrush.com/blog/using-guest-blogging-as-a-link-building-strategy/"
canonical: "https://www.semrush.com/blog/using-guest-blogging-as-a-link-building-strategy/"
author: "Dmitry Dragilev"
published: "2017-06-28T07:18:00+00:00"
updated: "2020-11-26T07:02:00+00:00"
categories:
  - "Link Building"
freshness_reasons:
  - "date_2020_very_old"
schema_genre: "Link Building"
fetched_at: "2026-06-12T20:23:46+00:00"
status_code: 200
html_hash: "10dc1fa9a4e763622b11d454611d6a7a46d1cd3653f0082c0f2db86a276105e8"
clean_word_count: 4354
clean_char_count: 26801
---
# The Definitive Guide to Using Guest Blogging as a Link Building Strategy

“Guest blogging is dead!”

How many times have you heard variations of this statement on marketing blogs and forums? Despite evidence to the contrary, there are still a number of pervasive myths and beliefs about guest blogging, especially when it is used as a [link building](https://www.semrush.com/blog/link-building/) strategy.

I have published over 1,400 articles for myself and my clients in the last decade. My experience has shown that [guest blogging](https://www.semrush.com/blog/guest-blogging/) is fantastically effective when used correctly.
...
- [Dispelling the Guest Blogging Myth](#header2)
- [Why Guest Blogging](#header3)
- [Using Guest Blogging to Build Backlinks](#header4)
- [1. Before You Start](#header5)
- [2. Finding Guest Blogging Opportunities](#header9)
- [2. Filtering Guest Blogging Opportunities](#header14)
- [3. Approaching Guest Blog Targets](#header15)
- [4. Brainstorming Ideas](#header18)
- [5. Pitching Ideas](#header21)
- [6. Creating Content](#header22)
- [7. Go Live](#header26)
- [Over to You](#header27)

## Dispelling the Guest Blogging Myth

Let’s travel back in time to January 20, 2014, when Matt Cutts published his now famous post on guest blogging: [The decay and fall of guest blogging for SEO](https://www.mattcutts.com/blog/guest-blogging/).
...
![matt-cuts-guest-blogging](https://static.semrush.com/blog/uploads/media/1e/8d/1e8d261e8337c22c40bd6201a20c1e61/image6.png)
...
![matt-cutts-email-spammer](https://static.semrush.com/blog/uploads/media/f0/e5/f0e5c744620122922e247b607c27920b/image10.png)
...
For such guest posts, [Google had another post about](https://webmasters.googleblog.com/2017/05/a-reminder-about-links-in-large-scale.html) “large scale article campaigns” (read: mass guest blogging). As per Google, the following three tactics are particularly frowned upon:
...
![comments-moz-blog](https://static.semrush.com/blog/uploads/media/83/74/8374e55a0a29a1cd58c10caafa36afc6/image9.png)
...
![Youtube video thumbnail](https://i.ytimg.com/vi/xQmQeKU25zg/hq720.jpg)
...
This idea aligns with Google’s mission: to provide value to users. This mission is so important that [Google even penalized Wall Street Journal](https://www.bloomberg.com/news/articles/2017-06-05/wsj-ends-google-users-free-ride-then-fades-in-search-results) when it stopped providing value.
...
More than [backlinks](https://www.semrush.com/blog/what-are-backlinks/), this is the reason you need to take up guest blogging. The more sites your content and name appear on, the more authoritative Google sees you (and by proxy, your sites) as.

In fact, this is one of the major reasons why I built [JustReachOut](https://justreachout.io/blog/pr-outreach/) in the first place - to help startups do their own PR and get found on other websites.
...
Guest blogging works. In fact, I used it to [rank a site #1 for a competitive, high-volume keyword](https://www.criminallyprolific.com/ranking-high-volume-keyword/) in under 90 days. I will show examples from this post to show you guest blogging works for SEO. I will also show you how to use guest blogging as a link building strategy.
...
![non-optimized-website-design](https://static.semrush.com/blog/uploads/media/f2/4a/f24ab21256805601a15b908df85b4eb2/image4.png)
...
To find these pages, use [Google search operators](https://www.semrush.com/blog/google-search-operators/) like the following:
...
![keyword-research](https://static.semrush.com/blog/uploads/media/5f/50/5f50a0450e278e1b6af80df017b101ac/image7.png)
...
![dmitry-dragilev-guest-post](https://static.semrush.com/blog/uploads/media/cb/43/cb4341a4d1e1721fa111230c4bf43af2/image1.png)
...
![backlinks justreachout pr seo](https://static.semrush.com/blog/uploads/media/06/73/06733fa60fa10c89292e99267e153a8d/image12.png)
...
[Buzzsumo](https://app.buzzsumo.com) isn’t just great for brainstorming content ideas. It also has a nifty feature to find guest blogging opportunities.
...
![buzzsumo-backlinks](https://static.semrush.com/blog/uploads/media/9a/80/9a80cfd7a0856ede9c1d6d4391a64f46/image11.png)
...
I have [covered a bunch of these tools and tactics in the past](https://www.criminallyprolific.com/find-anyones-email/), so I won’t repeat them here. For the most part, you won’t need anything more than [Interseller.io](https://www.interseller.io/) or [AnyMailFinder](https://anymailfinder.com/) to find emails.

With Interseller.io, for instance, you just need to enter your target’s name and domain name, and it will do the rest.

![interseller-email-lookup](https://static.semrush.com/blog/uploads/media/77/28/77285a710004d2f61acb1dcb2d3c2c2a/image3.png)
...
If you need something more industrial strength, check out [Clearbit](http://clearbit.com/). Their database is incredibly accurate, and they can do bulk lookups very easily.
...
![great-guest-post-example](https://static.semrush.com/blog/uploads/media/65/e3/65e31a75665f670b94abc31a5d559ab8/image8.png)
...
![copyblogger top content](https://static.semrush.com/blog/uploads/media/37/7c/377c0f16b2e0958c525b9e226d9e61ee/image5.png)
...
The personalized comment can be related to something they publicly posted on Twitter recently, their last blog post, etc. You can skip this for smaller blogs, but it helps you get noticed by busier bloggers and editors. Check out this [article for more cold email templates](https://www.criminallyprolific.com/cold-email-template/) and this one for inspiration on making your [email endings more memorable](https://www.criminallyprolific.com/email-endings/).

If you don’t get a response to your initial pitch, wait a week then follow-up. Use a tool like [MixMax](http://mixmax.com) to automate follow-up.
...
For example, take a look at the [Pipedrive post on sales management](https://blog.pipedrive.com/2016/05/sales-management/):

![pipedrive-blog-headline](https://static.semrush.com/blog/uploads/media/3a/e6/3ae626211a6d3f28384e86a2dcf2bc9b/image13.png)
...
![pipedrive-sales-management](https://static.semrush.com/blog/uploads/media/c5/db/c5db27b516eb2218b1359e534d100312/image2.png)
