...
canonical: "https://ahrefs.com/blog/new-rank-tracker-release/"
author: "Tim Soulo"
published: "2017-08-29T09:01:04+00:00"
updated: "2025-12-18T14:09:55+00:00"
categories:
  - "Product Blog"
freshness_reasons:
  - "product_or_tool_content"
fetched_at: "2026-06-12T11:53:21+00:00"
status_code: 200
html_hash: "4c37c6463958c55d50e7909b1da8e2f47954ede68053de4a5eb8187a6b05a041"
clean_word_count: 1768
clean_char_count: 10262
---
# This is the new Rank Tracker by Ahrefs
...
Which is why the new Ahrefs’ Rank Tracker tool keeps an eye on 12 different [types of SERP features](https://moz.com/learn/seo/serp-features) and shows all changes on this cool graph:
...
1. Search volume;
2. Traffic (& its delta);
3. [Keyword difficulty](https://ahrefs.com/blog/keyword-difficulty/);
4. SERP features.

And under the “Metrics” tab you get all the advanced metrics from [Keywords Explorer tool](https://ahrefs.com/keywords-explorer):
...
Everyone knows that [a single page can rank well for thousands of relevant keywords](https://ahrefs.com/blog/also-rank-for-study/). That is why we have added a report that groups all your tracked keywords by the ranking page:

Sidenote.

In all honesty, the number of page-level metrics that we show in this report could be a bit better, considering [the amount of SEO data that we have at Ahrefs](/blog/ahrefs-seo-metrics/). So most likely we will soon add some extra data there.
...
Another idea was to showcase the highest position that each of your tracked keywords reached in the last 7 / 30 / 90 days. Let us know if you like it more than the “delta” that we have right now.

## 7. Locations & Accuracy
...
A few weeks ago we released [**a teaser video of the new Rank Tracker**](https://youtu.be/wwfBwtiLJPg) and then a few voluntary beta testers gave a new tool a spin, all of which led to some absolutely amazing feedback.
