...
canonical: "https://ahrefs.com/blog/healthline-seo-case-study/"
author: "Michal Pecánek"
published: "2023-04-10T04:58:10+00:00"
updated: "2025-12-18T14:11:29+00:00"
categories:
  - "Data & Studies"
freshness_reasons:
  - "news_or_research"
fetched_at: "2026-06-12T11:35:42+00:00"
status_code: 200
html_hash: "871b3a5689a929905010d3cd6ff97c86315870052ab944c9a288fddca10a70ed"
clean_word_count: 2569
...
](https://ahrefs.com/blog/wp-content/uploads/2023/04/image7-2.png)

Healthline is owned by media giant company Red Ventures, which has a whole [RVO Health subdivision](https://rvohealth.com/) comprising many domains in this [YMYL](https://ahrefs.com/seo/glossary/ymyl-pages) niche. One of them is also Medical News Today that you can see among the biggest players listed in the chart above.
...
Screenshot taken from the **Site structure** report in Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer).
...
Screenshot taken from **Page Explorer** in Ahrefs’ [Site Audit](https://ahrefs.com/site-audit).

But more often than not, you’ll need some more unique points and headings to align perfectly with the [search intent](https://ahrefs.com/blog/search-intent/).
...
I think most people associate ranking for one keyword using multiple pieces of content with a phenomenon that hurts one or more of these pages. This is known as [keyword cannibalization](https://ahrefs.com/blog/keyword-cannibalization/).
...
Using Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer), I exported SERPs for the first 1K keywords with the highest search volume from the previously shown **Organic keywords** report. Then I extracted domains from all ranking URLs and created the pivot table above that counted how many times a given domain ranked in the top 10 for each keyword. Lastly, I used the SUBTOTAL function that could count the number of rows filtered by COUNTA of Domain of two or more.

Last but not least, another way of taking more SERP estate is to rank with both written content and videos. You guessed it. Healthline also has a [thriving YouTube channel](https://www.youtube.com/@HealthlineMedia), and it manages to own multiple results in this manner as well:

![Simultaneously ranking with an article and a video

## 3. Don’t overlook your visitors’ engagement

Two confessions: I hate the UX of most websites with display ads, and [I often refer](https://ahrefs.com/blog/seo-metrics-to-track/#bounce-rate) to engagement metrics like bounce rate as vanity metrics.
...
There are three aspects worth taking a closer look at because SEO and UX are [closely intertwined disciplines](https://ahrefs.com/blog/seo-marketing-strategy/#aligning-seo-with-other-disciplines).
...
Chances are that it’s also a positive SEO signal, but we’re getting into speculations here. No one officially confirmed signals like [dwell time](https://ahrefs.com/seo/glossary/dwell-time) to be a ranking factor.
...
Screenshot and HTML code taken from Ahrefs’ [Site Audit](https://ahrefs.com/site-audit) crawl data.

Yes, the long-dead [meta keywords](https://ahrefs.com/blog/meta-keywords/) can still be encountered. While they don’t play any role in rankings (at least not for Google), they can come in handy for tagging the topics of each piece of content to create an internal topical hierarchy. Some advanced CMSes ([like the headless ones](https://ahrefs.com/blog/headless-cms-seo/)) recommend doing it for this purpose too.

The sailthru.tags is a meta tag for categorization and user interest tracking [used for a personalization engine](https://getstarted.sailthru.com/site/personalization-engine/meta-tags/). Healthline takes catering to search intent and users’ interests very seriously.
...
Screenshot taken from the [dataslayer tool](https://chrome.google.com/webstore/detail/dataslayer/ikbablmmjldhamhcldjjigniffkkjgpo) added to Chrome Developer Tools.

## 5. Get inspiration from this E-E-A-T signaling masterclass

It will hardly surprise anyone that a successful website with 100% YMYL content excels in signaling [E-E-A-T](https://ahrefs.com/blog/eeat-seo/). But there are many aspects of this worth bringing up.
...
It has a team of in-house writers and guest freelancers with various qualifications related to health and medicine. These people don’t necessarily need to be experts in a certain topic, but their backgrounds ensure that they can put together [great content](https://ahrefs.com/blog/how-to-write-great-content/):
...
[Healthline’s medical team](https://www.healthline.com/about/medical-team) consists of four divisions that create a huge professional network with expertise for likely any medical topic you can think of:
...
https://twitter.com/Marie\_Haynes/status/966325146968559616

Everyone I clicked on Healthline seems to have great professional backgrounds and credentials:

![Healthline's reviewer bio example

Diving into stuff like [h-index](https://en.wikipedia.org/wiki/H-index) or other author-level metrics seemed like an overkill here, so I at least looked up a few authors and reviewers in Google Scholar. Almost everyone returned relevant papers and articles from the Scholar index.

![Google Scholar returning results for Healthline's editorial team member

All of these things in academia are basically like backlinks in SEO. I won’t be surprised if all the data we’re showing here was interconnected on the entity level and that Google took it into consideration not only for enhancing the [Knowledge Graph](https://ahrefs.com/blog/google-knowledge-graph/) but also for rankings.
...
Screenshot taken from the **Referring domains** report in Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer).
...
You can access all of this from its [About page](https://www.healthline.com/about/about-us) with a click or two.

For example, here’s an excerpt from its [“product selection process” page](https://www.healthline.com/about/product-selection-process) that clearly signals the trustworthiness of its recommendations:
...
Anthony Machi from Healthline’s SEO team [said](https://www.youtube.com/watch?v=SjN7xkkfnHE&t=330s) that they already had a 50:50 split for publishing new and updating old content back in 2022.
...
Got any questions or comments? Let me know [on Twitter](https://twitter.com/michalpecanek).
