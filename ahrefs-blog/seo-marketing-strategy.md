...
canonical: "https://ahrefs.com/blog/seo-marketing-strategy/"
author: "Jamie Grant"
published: "2023-01-04T06:00:00+00:00"
updated: "2024-10-17T16:45:53+00:00"
categories:
  - "General Marketing"
  - "General SEO"
freshness_reasons:
  - "date_2024_watch"
fetched_at: "2026-06-12T12:06:02+00:00"
status_code: 200
html_hash: "c74fc47c32634c86f819f0627ea770008616c62790ca8646a488683b71f7888c"
clean_word_count: 3267
clean_char_count: 19945
---
...
Getting the [“buy-in” for SEO investment](https://ahrefs.com/blog/seo-buy-in/) can be tricky. In some businesses, this can lead to SEO being underutilized through a lack of investment and implementation. Here are four reasons why SEO should receive the focus it deserves.
...
From this search term alone, we know that the users who search for this keyword want what we sell. Using Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer), we can also see that the keyword “cheap football kits” attracts 6,300 searches per month (globally).
...
In SEO, you’re not just limited to targeting users at one stage of the [marketing funnel](https://ahrefs.com/blog/marketing-funnels/). The ability to target potential customers through informational blog content and transactional product/service-focused landing pages is what makes SEO both exciting and lucrative.
...
Using Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer), simply enter your keyword and scroll down to the “SERP overview” to see what kind of pages are ranking. This method is great for seeing the search results alongside useful backlink and keyword data.
...
The SEO team can ensure you are maximizing “SERP real estate” by being an entity in the [Knowledge Graph](https://ahrefs.com/blog/google-knowledge-graph/) and targeting search features such as [People Also Ask](https://ahrefs.com/blog/people-also-ask/). Furthermore, the SEO team can ensure all applicable content is up to date and well optimized.
...
At the EffWorks Global 2020 event hosted by IPA (a U.K. trade body), effectiveness guru [Les Binet shared](https://ipa.co.uk/news/binet-presents-fast-cheap-predictive-share-of-search-metric) how he was experimenting with “share of search” to predict market share “sometimes up to a year ahead.” Les described the metric as a fast and predictive measure for short- and long-term ad effects.
...
For example, I’ve taken five popular U.S. donut brands and put them into Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer).
...
Most web users now use a mobile device instead of a desktop or tablet. This is reflected in Google’s algorithm, with mobile usability being an important ranking factor. Google will also [predominantly crawl the mobile version](https://ahrefs.com/blog/mobile-first-indexing/) of your website.

Another UX optimization, which is also a ranking signal in SEO, is page speed.

Page speed, albeit more of a minor ranking signal, is used in the algorithm and is more important than ever in SEO following the introduction of [Core Web Vitals](https://ahrefs.com/blog/core-web-vitals/) as a ranking factor in 2021. Core Web Vitals focus on three key metrics that have a big impact on the experience of the user. [Largest Contentful Paint](https://ahrefs.com/blog/largest-contentful-paint-lcp/) (loading), [First Input Delay](https://ahrefs.com/blog/first-input-delay-fid/) (interactivity), and [Cumulative Layout Shift](https://ahrefs.com/blog/cumulative-layout-shift-cls/) (visual stability).
...
A third key optimization used in both UX and SEO is site structure. Ensuring your content is organized and [internally linked](https://ahrefs.com/blog/prioritize-internal-linking/) helps users and bots discover your content.

Keen to hear more about the importance of site structure for both UX and SEO? Be sure to check out our Michal Pecánek’s [guide to website structure](https://ahrefs.com/blog/website-structure/).

Bonus tip

Breadcrumbs are great for user experience. They allow users (and bots) to navigate through the site’s structure easily.

Breadcrumb linking is an [aspect of internal linking that is undervalued](https://ahrefs.com/blog/prioritize-internal-linking/). Breadcrumb links are highly effective at passing [PageRank](https://ahrefs.com/blog/google-pagerank/) due to their prominent on-page location.

### SEO and PR

Public relations (PR) can have a significant influence on SEO performance. So much so that SEOs have formed [digital PR](https://ahrefs.com/blog/digital-pr/) (DPR or sometimes “SEO PR”), a spin-off of traditional PR designed to focus on the areas that benefit SEO the most.

While similar to traditional PR, DPR is more focused on [building backlinks](https://ahrefs.com/seo/link-building) and growing brand awareness through online publications.
...
So how can we go about this? My colleague, [Charlotte Crowther](https://twitter.com/CharCrowtherPR), who is the digital PR manager at [Kaizen](https://kaizen.co.uk/), shares her top three tips to ease this situation:
...
Image from the **Overview** report, via Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer).
...
Looking to acquire traffic through [Google Discover](https://ahrefs.com/blog/google-discover/)? In Michal’s blog on this topic, he discusses the correlation between posts that get traction on social media and those that perform well on Google Discover.
